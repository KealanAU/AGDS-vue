...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/h3@1.15.5/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/@vue+shared@3.5.29/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/ufo@1.6.3/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/vue@3.5.29_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/unstorage@1.17.4_db0@0.3.4_better-sqlite3@12.6.2__ioredis@5.10.0/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/unstorage@1.17.4_db0@0.3.4_better-sqlite3@12.6.2__ioredis@5.10.0/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/youch@4.1.0/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/devalue@5.6.3/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/vue@3.5.29_typescript@5.9.3/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/unhead@2.1.10/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/unhead@2.1.10/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/kealanclarke/Documents/Code/agds-vue/node_modules/.pnpm/db0@0.3.4_better-sqlite3@12.6.2/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/kealanclarke/Documents/Code/agds-vue/docs/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/kealanclarke/Documents/Code/agds-vue/docs","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/kealanclarke/Documents/Code/agds-vue/docs/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/kealanclarke/Documents/Code/agds-vue/docs/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/kealanclarke/Documents/Code/agds-vue/docs/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kealanclarke/Documents/Code/agds-vue/docs/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/components/sql_dump.txt/_payload.json": {
        "prerender": true
      }
    }
  },
...
const _YXG3nlQuBNXycVSW56McceM_Wl9FMuE1hYO139sk4 = (function(nitro) {
...
const _Gg2Xevvo0D0qKTAZNGFyCt4C9YQ9BPKnm_T8khOJw = (nitroApp) => {
...
const plugins = [
  _YXG3nlQuBNXycVSW56McceM_Wl9FMuE1hYO139sk4,
_Gg2Xevvo0D0qKTAZNGFyCt4C9YQ9BPKnm_T8khOJw
];
...
const getServerEntry = () => import('file:///Users/kealanclarke/Documents/Code/agds-vue/docs/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/kealanclarke/Documents/Code/agds-vue/docs/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _M0CBy9 = eventHandler(async (event) => {
  ...
  return await import('file:///Users/kealanclarke/Documents/Code/agds-vue/docs/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const checksums = {
  "components": "v3.5.0--Nx0bEGGaVA5JVXjZoe7PXjpaq82m2fFlszfbu1zDd0A"
};
...
const _lazy_KvZ_z0 = () => Promise.resolve().then(function () { return renderer$1; });
