import { AgDSProgressIndicator as e } from './CQR9mWth.js'
import { e as i, o as t, c as p, f as a, u as s } from './Czyq2uHh.js'
const c = { style: { 'max-width': '400px', width: '100%' } },
  d = i({
    ...
    setup(l) {
      ...
      return (m, b) => (
        ...
        p('div', c, [
          l.variant === 'statuses'
            ? (t(), a(s(e), { key: 0, items: r, 'active-path': 'In progress step' }))
            : l.variant === 'sub-items'
              ? (t(), a(s(e), { key: 1, items: n, 'active-path': '/apply/contact/address' }))
              : l.variant === 'bodyAlt'
                ? (t(),
                  a(s(e), {
                    key: 2,
                ...
                : (t(), a(s(e), { key: 3, items: o, 'active-path': '/apply/personal' })),
        ])
      )
    },
  }),
  f = Object.assign(d, { __name: 'ProgressIndicatorDemo' })
export { f as default }
