...
:root {
  ...
  --agds-color-focus: #your-focus-colour;
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/foundations/tokens" }, {
            ...
            _push2(` or `);
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/components" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`browse all components`);
                } else {
                  return [
                    createTextVNode("browse all components")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("article", { class: "prose-page" }, [
                ...
                createVNode("pre", null, [
                  createVNode("code", null, "pnpm add AGDS-vue")
                ]),
                ...
                createVNode("pre", null, [
                  createVNode("code", null, "import { createApp } from 'vue'\nimport AgDSVue from 'AGDS-vue'\nimport 'AGDS-vue/styles'\nimport App from './App.vue'\n\ncreateApp(App).use(AgDSVue).mount('#app')")
                ]),
                createVNode("h2", null, "Import individually"),
                createVNode("p", null, [
                  createTextVNode(" For better tree-shaking, import only the components you need. Still import the stylesheet once in "),
                  createVNode("code", null, "main.ts"),
                ...
                createVNode("pre", null, [
                  createVNode("code", null, "<!-- MyComponent.vue -->\n<script setup>\nimport { AgDSButton } from 'AGDS-vue'\n<\/script>")
                ]),
                ...
                createVNode("pre", null, [
                  createVNode("code", null, "import AgDSVue from 'AGDS-vue'\n\nexport default defineNuxtPlugin((nuxtApp) => {\n  nuxtApp.vueApp.use(AgDSVue)\n})")
                ]),
                createVNode("p", null, [
                ...
                createVNode("pre", null, [
                  createVNode("code", null, "export default defineNuxtConfig({\n  css: ['AGDS-vue/styles'],\n  plugins: ['~/plugins/AGDS-vue.ts'],\n})")
                ]),
                createVNode("h2", null, "Design tokens"),
                createVNode("p", null, [
                  createTextVNode(" All styles use "),
                  createVNode("code", null, "--agds-*"),
                  createTextVNode(" CSS custom properties. The stylesheet imported above includes all tokens. To override any token, declare it in your own CSS after the import: ")
                ]),
                createVNode("pre", null, [
                  createVNode("code", null, "/* your-overrides.css */\n:root {\n  --agds-color-brand: #your-brand-colour;\n  --agds-color-focus: #your-focus-colour;\n}")
                ]),
                createVNode("div", { class: "callout" }, [
                  createVNode("strong", null, "Next:"),
                  createVNode(_component_NuxtLink, { to: "/foundations/tokens" }, {
                    default: withCtx(() => [
                      createTextVNode("Explore the full token reference")
                    ]),
                    _: 1
