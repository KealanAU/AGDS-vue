...
const ao = /* @__PURE__ */ Symbol('agds:core'),
...
function va(e) {
  return Object.fromEntries(Object.keys(J).map((t) => [J[t], e[t]]))
}
const E = {
...
function cb(e, t = (n) => n) {
  if (Ot(e)) {
    if (Array.isArray(e)) return e.map((n) => (Ot(n) ? t(n) : null))
    if (typeof e == 'object') {
      const n = e
      return Co.map((a) => {
...
const Ha = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = useAttrs()
      function a(s) {
        if (s !== void 0) return typeof s == 'number' ? `var(--agds-space-${s})` : s
      }
      const o = computed(() => {
        const s = a(t.paddingTop) ?? a(t.paddingY),
          r = a(t.paddingBottom) ?? a(t.paddingY),
          u = a(t.paddingLeft) ?? a(t.paddingX),
          g = a(t.paddingRight) ?? a(t.paddingX),
          c = {
            display: t.display,
      ...
      return (s, r) => (
        openBlock(),
        createBlock(
          resolveDynamicComponent(t.as ?? 'div'),
          mergeProps(unref(n), { style: o.value }),
          {
            default: withCtx(() => [renderSlot(s.$slots, 'default')]),
            _: 3,
          },
  ...
  at = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      return (a, o) => (
        ...
        createBlock(
          Ha,
          normalizeProps(guardReactiveProps(n.value)),
          {
  ...
  Mo = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      return (o, s) => (
        ...
        createBlock(
          resolveDynamicComponent(t.as ?? 'div'),
          mergeProps(unref(n), { style: a.value }),
          {
  ...
  pt = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      return (n, a) => (
        ...
        createBlock(
          at,
          mergeProps(t, { 'flex-direction': 'column' }),
          {
...
function Lo(e, t) {
  const n = e.icons,
    a = e.aliases || /* @__PURE__ */ Object.create(null),
    o = /* @__PURE__ */ Object.create(null)
  function s(r) {
    if (n[r]) return (o[r] = [])
    if (!(r in o)) {
      o[r] = null
      const u = a[r] && a[r].parent,
        g = u && s(u)
      g && (o[r] = [u].concat(g))
    }
    return o[r]
...
function To(e, t, n) {
  const a = e.icons,
    o = e.aliases || /* @__PURE__ */ Object.create(null)
  let s = {}
  function r(u) {
    s = ha(a[u] || o[u], s)
  }
...
function Vt(e, t) {
  for (const n in t) if (n in e && typeof e[n] != typeof t[n]) return false
  return true
}
function Za(e) {
...
function Vo(e) {
  ...
  if (t) {
    const n = Qe(t.provider, t.prefix),
      a = t.name
...
function Wo(e, t) {
  ...
  ;[n, a].forEach((D) => {
    ...
    B
      ? I
        ...
        : (_.push(
          ...
          (o.top = o.left = 0))
      : I &&
        (_.push('translate(' + (0 - o.left).toString() + ' ' + (o.height + o.top).toString() + ')'),
        _.push('scale(1 -1)'),
        (o.top = o.left = 0))
    let H
    switch ((P < 0 && (P -= Math.floor(P / 4) * 4), (P = P % 4), P)) {
      case 1:
        ;((H = o.height / 2 + o.top),
          _.unshift('rotate(90 ' + H.toString() + ' ' + H.toString() + ')'))
        break
      case 2:
        _.unshift(
          'rotate(180 ' +
    ...
    ;(P % 2 === 1 &&
      (o.left !== o.top && ((H = o.left), (o.left = o.top), (o.top = H)),
      o.width !== o.height && ((H = o.width), (o.width = o.height), (o.height = H))),
      _.length && (s = No(s, '<g transform="' + _.join(' ') + '">', '</g>')))
  })
  const r = a.width,
    u = a.height,
    g = o.width,
  ...
  let f, m
  r === null
    ? ((m = u === null ? '1em' : u === 'auto' ? c : u), (f = _a(m, g / c)))
    : ((f = r === 'auto' ? g : r), (m = u === null ? _a(f, c / g) : u === 'auto' ? c : u))
  const p = {},
    x = (D, _) => {
      jo(_) || (p[D] = _.toString())
    }
...
const Uo = /\sid="(\S+)"/g,
  Zo = 'IconifyId' + Date.now().toString(16) + ((Math.random() * 16777216) | 0).toString(16)
let Ko = 0
function Yo(e, t = Zo) {
  const n = []
  let a
  for (; (a = Uo.exec(e)); ) n.push(a[1])
  if (!n.length) return e
  const o = 'suffix' + ((Math.random() * 16777216) | Date.now()).toString(16)
  return (
    n.forEach((s) => {
      const r = typeof t == 'function' ? t(s) : t + (Ko++).toString(),
        u = s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')
      e = e.replace(
...
function ls(e) {
  ...
  return (
    e.forEach((o) => {
      if (a.name === o.name && a.prefix === o.prefix && a.provider === o.provider) return
      a = o
      const s = o.provider,
        r = o.prefix,
        u = o.name,
        g = n[s] || (n[s] = /* @__PURE__ */ Object.create(null)),
        c = g[r] || (g[r] = Qe(s, r))
      let f
      u in c.icons
        ? (f = t.loaded)
    ...
    setTimeout(() => {
      ...
      t.forEach((s) => {
        ...
        ;((r.pending = r.pending.filter((g) => {
          ...
          r.pending.length !== u &&
            (n || Ja([e], s.id),
            s.callback(r.loaded.slice(0), r.missing.slice(0), r.pending.slice(0), s.abort)))
      })
    }))
}
let rs = 0
  ...
  ;(e.iconsToLoad ? (e.iconsToLoad = e.iconsToLoad.concat(t).sort()) : (e.iconsToLoad = t),
    e.iconsQueueFlag ||
      ...
      setTimeout(() => {
        ...
        if ((u.length && st(e, u, null), !r.length)) return
...
const bs = (e, t) => {
  ...
  if (!a.pending.length) {
    ...
    return (
      t &&
        setTimeout(() => {
          g && t(a.loaded, a.missing, a.pending, Sa)
        }),
      () => {
        g = false
      }
  ...
  return (
    ...
    a.pending.forEach((g) => {
      const { provider: c, prefix: f, name: m } = g,
        p = Qe(c, f),
        x = p.pendingIcons || (p.pendingIcons = /* @__PURE__ */ new Set())
...
function _s(e, t) {
  ...
  for (const a in t) {
    const o = t[a],
      s = typeof o
    a in Xa
      ? (o === null || (o && (s === 'string' || s === 'number'))) && (n[a] = o)
      : s === typeof n[a] && (n[a] = a === 'rotate' ? o % 4 : o)
  }
  return n
}
const ys = /[\s,]+/
...
const Ca = (e, t) => {
  const n = _s(xa, t),
    ...
    s = {},
    r = t.style,
    u = typeof r == 'object' && !(r instanceof Array) ? r : {}
  for (let D in t) {
    const _ = t[D]
    if (_ !== void 0)
      switch (D) {
  ...
  if ((n.inline && (s.verticalAlign = '-0.125em'), o === 'svg')) {
    ...
    return (
      ...
      (a.innerHTML = Yo(g.body, _ ? () => _ + 'ID' + D++ : 'iconifyVue')),
      h('svg', a)
    )
  }
  const { body: f, width: m, height: p } = e,
    x = o === 'mask' || (o === 'bg' ? false : f.indexOf('currentColor') !== -1),
    h$1 = $s(f, {
      ...c,
      width: m + '',
      height: p + '',
...
const Is = {
  ...
  Ms = defineComponent(
    (e, { emit: t }) => {
      ...
      function u() {
        ...
        let f
        if (typeof c != 'string' || (f = It(c, false, true)) === null) return null
        let m = Vo(f)
        if (!m) {
          const h2 = n.value
          return (
        ...
        const x = ['iconify']
        return (
          f.prefix !== '' && x.push('iconify--' + f.prefix),
          f.provider !== '' && x.push('iconify--' + f.provider),
          { data: m, classes: x }
        )
      }
      function g() {
  ...
  Bs = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        ...
        o = computed(() => (typeof t.name == 'string' ? t.name.replace(/^i-/, '') : '')),
        s = computed(() => {
          const g = t.size
      ...
      return (g, c) =>
        typeof e.name == 'string'
          ...
          : (openBlock(),
            createBlock(
              resolveDynamicComponent(e.name),
              mergeProps(
                {
                  key: 1,
                  class: 'agds-icon',
  ...
  _e = /* @__PURE__ */ A(Bs, [['__scopeId', 'data-v-7d15793f']]),
  ...
  an = /* @__PURE__ */ A(Ls, [['__scopeId', 'data-v-7b99561f']]),
  Ts = { class: 'agds-breadcrumbs__item' },
  Fs = ['href', 'aria-current'],
  Ps = {
    key: 0,
    class: 'sr-only',
  },
              ...
              ? (openBlock(),
                createElementBlock(
                  ...
                  [
                    ...
                    e.current
                      ? (openBlock(), createElementBlock('span', Ps, ' (current page)'))
              ...
              : (openBlock(),
                createElementBlock(
                  ...
                  [
                    createTextVNode(toDisplayString(e.label), 1),
                    e.current
                      ? (openBlock(), createElementBlock('span', Vs, ' (current page)'))
                      : createCommentVNode('', true),
                  ],
                  8,
                  Os,
  ...
  vt = /* @__PURE__ */ A(Rs, [['__scopeId', 'data-v-74bbe2c0']]),
  Es = { class: 'agds-breadcrumbs__item' },
  ...
  qs = /* @__PURE__ */ A(Gs, [['__scopeId', 'data-v-ef32eca7']]),
  zs = ['aria-label'],
  Hs = { class: 'agds-breadcrumbs__list' },
  Ns = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => t.links[0]),
        a = computed(() => t.links[t.links.length - 1]),
        o = computed(() => t.links.filter((c, f, m) => f !== 0 && f !== m.length - 1)),
        s = computed(() => o.value.length > 0),
        r = ref(false),
        u = ref(null)
      async function g() {
        ...
        createElementBlock(
          'nav',
          {
            ...
            class: normalizeClass([
              'agds-breadcrumbs',
              { 'agds-breadcrumbs--collapsed': s.value && !r.value },
            ]),
          },
          [
  ...
  js = /* @__PURE__ */ A(Ns, [['__scopeId', 'data-v-44971669']]),
  Ws = ['type', 'disabled', 'aria-busy', 'aria-disabled'],
  Us = {
    'aria-live': 'assertive',
          ...
          [
              ...
              ? (openBlock(),
                createElementBlock(
                  'span',
                  {
                    ...
                    class: normalizeClass([
                      'agds-button__icon',
                      { 'agds-button__icon--hidden': a.loading },
                    ]),
                    'aria-hidden': 'true',
                  },
            ...
            createElementVNode(
              'span',
              {
                class: normalizeClass([
                  'agds-button__label',
                  { 'agds-button__label--hidden': a.loading },
                ]),
              },
            ...
            createElementVNode('span', Us, [
              a.loading
                ? (openBlock(),
                  createElementBlock('span', Zs, [
                    g[3] ||
                      (g[3] = createElementVNode(
                        'span',
                        {
  ...
  Ue = /* @__PURE__ */ A(Ys, [['__scopeId', 'data-v-8c021442']]),
  Xs = ['href', 'target', 'rel'],
  Qs = {
    key: 0,
        ...
        createElementBlock(
          ...
          [
            t.$slots.iconBefore
              ...
              : createCommentVNode('', true),
            createElementVNode('span', Js, [renderSlot(t.$slots, 'default', {}, void 0, true)]),
            t.$slots.iconAfter
              ? (openBlock(),
                createElementBlock('span', el, [
                  renderSlot(t.$slots, 'iconAfter', {}, void 0, true),
                ]))
              : createCommentVNode('', true),
            e.external
              ? (openBlock(), createElementBlock('span', tl, ', opens in a new tab'))
              : createCommentVNode('', true),
          ],
          42,
          Xs,
  ...
  nl = /* @__PURE__ */ A(al, [['__scopeId', 'data-v-84656420']]),
  ol = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      const u = computed(() => (o.pressed ? o.pressedLabel : o.label)),
        g = computed(() => a[o.iconType][String(o.pressed)])
      function c() {
          ...
          createSlots(
            ...
            [
              o.hiddenLabel
                ...
                : {
                    name: 'default',
                    fn: withCtx(() => [createTextVNode(toDisplayString(u.value), 1)]),
                    key: '0',
                  },
            ],
          ),
  ...
  sl = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      const n = e,
        a = t
      return (
        provide('accordionIndent', n.indent),
        provide('accordionBackground', n.background),
        (o, s) => (
          openBlock(),
          createBlock(
            unref(AccordionRoot),
            {
              ...
              'onUpdate:modelValue':
                s[0] || (s[0] = (r) => r !== void 0 && a('update:modelValue', r)),
            },
            {
              default: withCtx(() => [renderSlot(o.$slots, 'default', {}, void 0, true)]),
              _: 3,
            },
            8,
  ...
  ll = /* @__PURE__ */ A(sl, [['__scopeId', 'data-v-3c55f372']]),
  il = { class: 'agds-accordion-item__title' },
  rl = { class: 'agds-accordion-item__panel-inner' },
  dl = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = inject('accordionBackground', 'body'),
        a = computed(() => t.background ?? n),
        o = inject('accordionIndent', false)
      return (s, r) => (
        openBlock(),
        createBlock(
          unref(AccordionItem),
...
const gl = ['role', 'aria-label', 'aria-hidden'],
  fl = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = useAttrs(),
        a = computed(() => cl(t.name)),
        o = computed(() => n['aria-hidden'] === true || n['aria-hidden'] === 'true'),
        s = computed(() => {
          if (!o.value) return 'aria-label' in n ? n['aria-label'] || void 0 : t.name
        })
      return (r, u) => (
        openBlock(),
        createElementBlock(
  ...
  ml = /* @__PURE__ */ A(fl, [['__scopeId', 'data-v-d63a2b17']]),
  vl = {
    key: 0,
    class: 'agds-callout__icon',
  },
  pl = { class: 'agds-callout__content' },
  hl = {
    key: 0,
  ...
  bl = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => t.tone === 'neutral' && (t.onBodyAlt || t.background === 'shadeAlt')),
        a = computed(() => t.tone === 'info')
      return (o, s) => (
        openBlock(),
        createBlock(
          resolveDynamicComponent(t.as),
          {
            class: normalizeClass([
              'agds-callout',
              `agds-callout--${t.tone}`,
          ...
          {
            default: withCtx(() => [
              o.$slots.icon || a.value
                ? (openBlock(),
                  createElementBlock('span', vl, [
                    renderSlot(
                      o.$slots,
                      'icon',
                      {},
              ...
              createElementVNode('div', pl, [
                t.title
                  ? (openBlock(), createElementBlock('p', hl, toDisplayString(t.title), 1))
                  : createCommentVNode('', true),
  ...
  _l = /* @__PURE__ */ A(bl, [['__scopeId', 'data-v-7bd52606']]),
  yl = ['aria-label'],
  kl = {
  ...
  xl = { class: 'agds-global-alert__body' },
  wl = {
    key: 0,
    class: 'agds-global-alert__title',
  },
  Al = { class: 'agds-global-alert__content' },
  Dl = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => (t.tone === 'info' ? 'Information' : 'Warning')),
        a = computed(() => t.title || n.value)
      return (o, s) => (
        openBlock(),
        createElementBlock(
          'section',
          ...
          [
            ...
            createElementVNode('div', xl, [
              createElementVNode(
                ...
                [
                  t.title
                    ? (openBlock(), createElementBlock('h2', wl, toDisplayString(t.title), 1))
                    : createCommentVNode('', true),
  ...
  Cl = /* @__PURE__ */ A(Dl, [['__scopeId', 'data-v-8b1dd069']]),
  Se = {
...
const Bl = ['id', 'role', 'aria-labelledby', 'tabindex'],
  Ll = { class: 'agds-section-alert__icon-wrap' },
  Tl = {
    key: 0,
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 24 24',
  ...
  Ol = ['d'],
  Vl = ['id'],
  Rl = { class: 'agds-section-alert__body' },
  El = ['id'],
  Gl = ['id'],
  ql = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t }) {
      ...
      const a = getCurrentInstance()?.uid,
        o = computed(() => n.id ?? `section-alert-${a}`),
        s = computed(() => `${o.value}-icon`),
        r = computed(() => `${o.value}-title`),
        u = computed(() => `${o.value}-body`),
        g = useSlots(),
        c = computed(() => {
      ...
      const p = computed(() => Ml(n.tone)),
        x = computed(() => Il[p.value]),
        h2 = computed(() => ({
          '--sa-bg': x.value.bg,
        ...
        createElementBlock(
          ...
          [
            createElementVNode('span', Ll, [
              x.value.iconVariant === 'filled'
                ? (openBlock(),
                  createElementBlock('svg', Tl, [
                    createElementVNode(
                      'path',
                      {
                        'fill-rule': 'evenodd',
              ...
              createElementVNode(
                ...
                toDisplayString(x.value.iconLabel),
                9,
                Vl,
              ),
            ]),
  ...
  zl = /* @__PURE__ */ A(ql, [['__scopeId', 'data-v-425bc5dd']]),
  Ae = {
    // Filled (fill="currentColor", fill-rule="evenodd", clip-rule="evenodd")
    infoFilled:
      'M2.25 12c0-5.385 4.365-9.75 9.75-9.75S21.75 6.615 21.75 12 17.385 21.75 12 21.75 2.25 17.385 2.25 12Zm8.706-1.442c1.146-.573 2.437.463 2.126 1.706l-.709 2.836.042-.02a.75.75 0 0 1 .67 1.34l-.04.022c-1.147.573-2.438-.463-2.127-1.706l.71-2.836-.042.02a.75.75 0 1 1-.671-1.34l.041-.022ZM12 9a.75.75 0 1 0 0-1.5A.75.75 0 0 0 12 9Z',
...
const jl = ['aria-label'],
  ...
  Zl = ['d'],
  Kl = ['aria-label'],
  Yl = { class: 'agds-status-badge__label' },
  Xl = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => Nl(t.tone)),
        a = computed(() => Hl[n.value]),
        o = computed(() => t.appearance ?? t.weight ?? 'regular'),
        s = computed(() => ({
      ...
      return (r, u) => (
        ...
        createElementBlock(
          'span',
          {
            class: normalizeClass(['agds-status-badge', `agds-status-badge--${o.value}`]),
  ...
  fb = /* @__PURE__ */ A(Xl, [['__scopeId', 'data-v-e345cedd']]),
  Ql = { class: 'agds-summary-list' },
  Jl = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSummaryList',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('dl', Ql, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  ei = /* @__PURE__ */ A(Jl, [['__scopeId', 'data-v-392a1b7c']]),
  ti = { class: 'agds-summary-list-item' },
  ai = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSummaryListItem',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('div', ti, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  ni = /* @__PURE__ */ A(ai, [['__scopeId', 'data-v-730a1419']]),
  oi = { class: 'agds-summary-list-item__term' },
  si = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSummaryListItemTerm',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('dt', oi, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  li = /* @__PURE__ */ A(si, [['__scopeId', 'data-v-ffc85814']]),
  ii = { class: 'agds-summary-list-item__description' },
  ri = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSummaryListItemDescription',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('dd', ii, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  di = /* @__PURE__ */ A(ri, [['__scopeId', 'data-v-f432577d']]),
  ui = { class: 'agds-summary-list-item__action' },
  ci = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSummaryListItemAction',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('dd', ui, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  gi = /* @__PURE__ */ A(ci, [['__scopeId', 'data-v-4ddf851b']]),
  fi = ['id', 'role', 'aria-labelledby', 'tabindex'],
  mi = {
  ...
  pi = ['d'],
  hi = { class: 'agds-page-alert__inner' },
  bi = ['id'],
  _i = ['id'],
  yi = { class: 'agds-page-alert__title' },
  ki = ['id'],
  Si = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t }) {
      ...
      const a = getCurrentInstance()?.uid,
        o = computed(() => n.id ?? `page-alert-${a}`),
        s = computed(() => `${o.value}-tone`),
        r = computed(() => `${o.value}-title`),
        u = computed(() => `${o.value}-body`),
        g = useSlots(),
        c = computed(() => !!n.title || !!g.title),
        f = computed(() => {
          const B = [s.value]
            ...
            createElementVNode(
              'div',
              {
                class: normalizeClass([
                  ...
                  { 'agds-page-alert__body--with-close': !!_.value },
                ]),
              },
              [
                createElementVNode('div', hi, [
                  createElementVNode(
                    ...
                    toDisplayString(h2.value.iconLabel) + '. ',
                    9,
                    bi,
                  ),
                  c.value
  ...
  $i = /* @__PURE__ */ A(Si, [['__scopeId', 'data-v-6fcb44ed']]),
  oa = /* @__PURE__ */ Symbol('AgDSCard'),
  ...
  wi = /* @__PURE__ */ A(xi, [['__scopeId', 'data-v-5d0bfba8']]),
  Ai = /* @__PURE__ */ defineComponent({
  ...
  Di = /* @__PURE__ */ A(Ai, [['__scopeId', 'data-v-7dc7b6b5']]),
  Ci = /* @__PURE__ */ defineComponent({
  ...
  Ii = /* @__PURE__ */ A(Ci, [['__scopeId', 'data-v-33287fe1']]),
  Mi = { class: 'agds-card-inner' },
  Bi = /* @__PURE__ */ defineComponent({
    __name: 'AGDSCardInner',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('div', Mi, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  Li = /* @__PURE__ */ A(Bi, [['__scopeId', 'data-v-8cfc470e']]),
  Ti = /* @__PURE__ */ defineComponent({
    inheritAttrs: false,
    __name: 'AGDSCardLink',
    props: {
      as: { default: 'a' },
    ...
    setup(e) {
      const t = e,
        n = inject(oa),
        a = computed(() => !!n?.clickable)
      return (o, s) => (
        openBlock(),
        createBlock(
          resolveDynamicComponent(t.as),
          mergeProps(o.$attrs, {
            class: ['agds-card-link', a.value && 'agds-card-link--clickable'],
          }),
          {
            default: withCtx(() => [renderSlot(o.$slots, 'default', {}, void 0, true)]),
            _: 3,
  ...
  Fi = /* @__PURE__ */ A(Ti, [['__scopeId', 'data-v-57095540']]),
  Pi = { class: 'agds-details' },
  Oi = { class: 'agds-details__summary' },
  Vi = {
    key: 0,
    role: 'img',
    'aria-label': 'Information.',
  ...
  Ei = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('details', Pi, [
          createElementVNode('summary', Oi, [
            e.iconBefore
              ? (openBlock(),
                createElementBlock('span', Vi, [
                  ...(n[0] ||
                    (n[0] = [
                      createElementVNode(
                        'svg',
  ...
  Gi = /* @__PURE__ */ A(Ei, [['__scopeId', 'data-v-95913503']]),
  qi = { class: 'agds-tag' },
  zi = ['aria-label'],
  Hi = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTag',
    props: {
      label: {},
      href: {},
    ...
    setup(e, { expose: t, emit: n }) {
      const a = n,
        o = ref(null)
      return (
        t({ focusRemoveButton: () => o.value?.focus() }),
        (s, r) => (
          openBlock(),
          createElementBlock('span', qi, [
            (openBlock(),
            createBlock(
              resolveDynamicComponent(e.href ? 'a' : 'span'),
              mergeProps(e.href ? { href: e.href } : {}, {
  ...
  nn = /* @__PURE__ */ A(Hi, [['__scopeId', 'data-v-f65b9c8d']]),
  Ni = { class: 'agds-tags' },
  ...
  Wi = /* @__PURE__ */ A(ji, [['__scopeId', 'data-v-453cd2d1']]),
  ...
  Zi = /* @__PURE__ */ A(Ui, [['__scopeId', 'data-v-b905b6be']]),
  Ki = /* @__PURE__ */ defineComponent({
  ...
  Yi = /* @__PURE__ */ A(Ki, [['__scopeId', 'data-v-7b17447a']]),
  Xi = {
    key: 0,
  ...
  er = { class: 'agds-header-brand__heading-row' },
  tr = {
    key: 0,
  ...
  ar = ['href'],
  nr = { class: 'agds-header-brand__title-wrap' },
  or = {
    key: 0,
  ...
  ir = { class: 'agds-header-brand__text' },
  rr = { class: 'agds-header-brand__title-wrap' },
  dr = {
    key: 0,
    class: 'agds-header-brand__badge',
  },
            ...
            createElementBlock('div', Xi, [
              createElementVNode(
                ...
                [
                  ...
                  e.dividerPosition === 'between'
                    ? (openBlock(), createElementBlock('div', Ji))
                    : createCommentVNode('', true),
                  (openBlock(),
                  createBlock(
                    resolveDynamicComponent(e.secondHref ? 'a' : 'span'),
                    mergeProps(e.secondHref ? { href: e.secondHref } : {}, {
                      class: [
              ...
              createElementVNode('div', er, [
                e.dividerPosition === 'after'
                  ? (openBlock(), createElementBlock('div', tr))
                  : createCommentVNode('', true),
                createElementVNode(
                  'a',
                  {
                  ...
                  [
                    createElementVNode('div', nr, [
                      createElementVNode(
                        ...
                        toDisplayString(e.heading),
                        3,
                      ),
                      e.badgeLabel
                        ? (openBlock(),
                          createElementBlock('span', or, toDisplayString(e.badgeLabel), 1))
                        : createCommentVNode('', true),
                    ]),
                    e.subline
                      ? (openBlock(),
            ...
            createElementBlock(
              ...
              [
                t.$slots.logo
                  ...
                  : createCommentVNode('', true),
                t.$slots.logo
                  ? (openBlock(), createElementBlock('div', lr))
                  : createCommentVNode('', true),
                createElementVNode('div', ir, [
                  createElementVNode('div', rr, [
                    ...
                    e.badgeLabel
                      ? (openBlock(),
                        createElementBlock('span', dr, toDisplayString(e.badgeLabel), 1))
                      : createCommentVNode('', true),
                  ]),
                  e.subline
                    ? (openBlock(),
  ...
  on = /* @__PURE__ */ A(ur, [['__scopeId', 'data-v-085d4a93']]),
  cr = {
    key: 0,
      ...
      return (t, n) => (
        ...
        createElementBlock(
          'header',
          {
            class: normalizeClass([
              'agds-header',
              [`agds-header--${e.background}`, `agds-header--${e.size}`],
            ]),
          },
          [
            createElementVNode(
                    ...
                    createVNode(
                      ...
                      createSlots({ _: 2 }, [
                        t.$slots.logo
                          ? {
                              name: 'logo',
                              fn: withCtx(() => [renderSlot(t.$slots, 'logo', {}, void 0, true)]),
                              key: '0',
                            }
                          : void 0,
                        t.$slots.secondLogo
  ...
  fr = /* @__PURE__ */ A(gr, [['__scopeId', 'data-v-f1d1bde8']]),
  sn = /* @__PURE__ */ Symbol('DropdownMenu')
function nt() {
  const e = inject(sn)
  if (!e) throw new Error('useDropdownMenuContext must be called within AgDSDropdownMenu')
  return e
}
const mr = { class: 'agds-dropdown-menu' },
  vr = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        a = `agds-dropdown-menu-${getCurrentInstance()?.uid ?? 0}`,
        o = `${a}-button`,
        s = `${a}-panel`,
        r = ref(false),
        u = ref(-1),
        ...
        p = ref(void 0),
        x = computed(() => r.value),
        h2 = computed(() => g.value?.[u.value]?.id),
        D = ref(null),
        _ = ref(null)
      function B() {
        r.value = true
      ...
      function Z(q) {
        const re = Date.now(),
          me = re - m.value < 350,
          he = me ? f.value + q.toLowerCase() : q.toLowerCase(),
          ce = u.value >= 0 ? u.value : -1,
          De = me ? 0 : 1,
          ve = Array.from(g.value ?? []).map((j) =>
            (j.textContent ?? '')
              .toLowerCase()
              .replace(/(\r\n|\n|\r)/gm, '')
              .trim(),
          ...
          Me = ve
            .slice(ce + De)
            .concat(ve.slice(0, ce + De))
            .find((j) => j.startsWith(he)),
          R = Me ? ve.indexOf(Me) : ce
  ...
  ln = /* @__PURE__ */ A(vr, [['__scopeId', 'data-v-b81045cb']]),
  pr = ['id', 'disabled', 'aria-controls', 'aria-expanded'],
  hr = { class: 'agds-button__label agds-dropdown-menu-btn__label' },
  br = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      function c(f) {
        ;['ArrowDown', 'ArrowUp', 'Space', 'Enter'].includes(f.code) &&
          (f.preventDefault(), s(f.code))
      }
      return (f, m) => (
        openBlock(),
        createElementBlock(
          ...
          [
            createElementVNode('span', hr, [renderSlot(f.$slots, 'default', {}, void 0, true)]),
            createElementVNode(
              'span',
              {
                'aria-hidden': 'true',
                class: normalizeClass([
                  ...
                  { 'agds-dropdown-menu-btn__chevron--open': unref(t) },
                ]),
              },
              [
                ...(m[0] ||
  ...
  rn = /* @__PURE__ */ A(br, [['__scopeId', 'data-v-fabe2256']]),
  _r = ['id'],
  yr = ['id', 'aria-labelledby', 'aria-activedescendant'],
  ...
  dn = /* @__PURE__ */ A(kr, [['__scopeId', 'data-v-2ee68137']]),
  Sr = ['id'],
  $r = { class: 'agds-dm-item__content' },
  xr = { class: 'agds-dm-item__label' },
  wr = {
    key: 0,
  ...
  Ar = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      const n = e,
        a = t,
        { menuId: o, activeDescendantId: s, closeMenu: r } = nt(),
        u = getCurrentInstance()?.uid ?? 0,
        g = computed(() => n.id ?? `${o}-item-${u}`),
        c = computed(() => g.value === s.value),
        f = ref(null)
      watch(c, (p) => {
        p &&
          ...
          [
            createElementVNode('div', $r, [
              e.icon
                ...
                : createCommentVNode('', true),
              createElementVNode('span', xr, [renderSlot(p.$slots, 'default', {}, void 0, true)]),
            ]),
            p.$slots.endElement
              ? (openBlock(),
  ...
  Dr = /* @__PURE__ */ A(Ar, [['__scopeId', 'data-v-ed060a8e']]),
  Cr = ['id', 'href', 'target', 'rel'],
  Ir = { class: 'agds-dm-item__content' },
  Mr = { class: 'agds-dm-item__label' },
  Br = {
    key: 0,
    class: 'sr-only',
  },
  ...
  Tr = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      const n = e,
        ...
        g = computed(() => n.id ?? `${o}-item-${u}`),
        c = computed(() => g.value === s.value),
        f = computed(() => n.target === '_blank'),
        m = ref(null)
      watch(c, (x) => {
        x &&
          typeof m.value?.scrollIntoView == 'function' &&
          m.value.scrollIntoView({ block: 'nearest' })
      })
      function p(x) {
        ;(a('click', x), r())
      }
          ...
          [
            createElementVNode('div', Ir, [
              ...
              createElementVNode('span', Mr, [
                ...
                f.value
                  ? (openBlock(), createElementBlock('span', Br, ', opens in a new tab'))
                  : createCommentVNode('', true),
              ]),
            ]),
            x.$slots.endElement
              ? (openBlock(),
                createElementBlock('div', Lr, [
  ...
  un = /* @__PURE__ */ A(Tr, [['__scopeId', 'data-v-dae541f6']]),
  Fr = ['id', 'aria-checked'],
  Pr = { class: 'agds-dm-radio__stack' },
  Or = {
    key: 0,
        ...
        createElementBlock(
          ...
          [
            createElementVNode('div', Pr, [
              ...
              e.secondaryText
                ? (openBlock(), createElementBlock('span', Or, toDisplayString(e.secondaryText), 1))
                : createCommentVNode('', true),
            ]),
            p.$slots.endElement
              ? (openBlock(),
                createElementBlock('div', Vr, [
                  renderSlot(p.$slots, 'endElement', {}, void 0, true),
                ]))
              : createCommentVNode('', true),
          ],
  ...
  Er = /* @__PURE__ */ A(Rr, [['__scopeId', 'data-v-fa3319d4']]),
  Gr = /* @__PURE__ */ defineComponent({
  ...
  qr = /* @__PURE__ */ A(Gr, [['__scopeId', 'data-v-dad22ed0']]),
  zr = ['aria-hidden'],
  Hr = { class: 'agds-divider__text' },
  Nr = ['aria-hidden'],
          ...
          ? (openBlock(),
            createElementBlock(
              ...
              [
                ...
                createElementVNode('div', Hr, [renderSlot(o.$slots, 'default', {}, void 0, true)]),
                s[1] ||
                  (s[1] = createElementVNode(
                    'hr',
                    {
                      class: 'agds-divider__line',
                      'aria-hidden': 'true',
  ...
  cn = /* @__PURE__ */ A(jr, [['__scopeId', 'data-v-f2f47ea9']]),
  Wr = {
  ...
  Ur = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      return (t, n) => (openBlock(), createElementBlock('div', Wr, [createVNode(cn)]))
    },
  }),
  Zr = /* @__PURE__ */ A(Ur, [['__scopeId', 'data-v-bf52894b']]),
  Kr = /* @__PURE__ */ defineComponent({
    __name: 'AGDSHeading',
    props: {
      type: { default: 'h2' },
    ...
    setup(e) {
      ...
      return (s, r) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [renderSlot(s.$slots, 'default', {}, void 0, true)]),
            _: 3,
          },
          8,
          ['class', 'style'],
  ...
  He = /* @__PURE__ */ A(Kr, [['__scopeId', 'data-v-c5f1faef']]),
  ...
  ad = ['href', 'target', 'rel'],
  nd = { class: 'agds-feature-link-list-item__text' },
  od = { class: 'agds-feature-link-list-item__label' },
  sd = {
    key: 0,
            ...
            createElementVNode(
              ...
              [
                createElementVNode('span', nd, [
                  ...
                  e.secondaryText
                    ? (openBlock(),
                      createElementBlock('span', sd, toDisplayString(e.secondaryText), 1))
                    : createCommentVNode('', true),
                ]),
                n[0] ||
                  (n[0] = createElementVNode(
                    'svg',
                    {
                ...
                e.external
                  ? (openBlock(), createElementBlock('span', ld, ', opens in a new tab'))
                  : createCommentVNode('', true),
              ],
              8,
              ad,
  ...
  gn = /* @__PURE__ */ A(id, [['__scopeId', 'data-v-3de423b9']]),
  rd = { class: 'agds-feature-link-list' },
          ...
          createElementBlock(
            ...
            renderList(
              ...
              (a, o) => (
                ...
                createBlock(
                  gn,
                  mergeProps({ key: o }, { ref_for: true }, a, { background: e.background }),
                  null,
                  16,
                  ['background'],
                )
  ...
  ud = /* @__PURE__ */ A(dd, [['__scopeId', 'data-v-13873e69']]),
  cd = { class: 'agds-link-list-item' },
  gd = ['href', 'target', 'rel'],
  fd = {
    key: 0,
    class: 'sr-only',
        ...
        createElementBlock('li', cd, [
          createElementVNode(
            ...
            [
              createTextVNode(toDisplayString(e.label) + ' ', 1),
              e.target === '_blank'
                ? (openBlock(), createElementBlock('span', fd, ', opens in a new tab'))
                : createCommentVNode('', true),
            ],
            8,
            gd,
  ...
  fn = /* @__PURE__ */ A(md, [['__scopeId', 'data-v-657564fd']]),
          ...
          [
            ...
            createElementBlock(
              ...
              renderList(
                ...
                (a, o) => (
                  openBlock(),
                  createBlock(fn, mergeProps({ key: o }, { ref_for: true }, a), null, 16)
                ),
              ),
              128,
            )),
  ...
  pd = /* @__PURE__ */ A(vd, [['__scopeId', 'data-v-f737ef8d']]),
  bt = /* @__PURE__ */ Symbol('AgDSListDepth'),
  ...
  bd = /* @__PURE__ */ A(hd, [['__scopeId', 'data-v-f6f107f0']]),
  ...
  yd = /* @__PURE__ */ A(_d, [['__scopeId', 'data-v-ff0451d1']]),
  kd = { class: 'agds-list-item' },
  Sd = /* @__PURE__ */ defineComponent({
    __name: 'AGDSListItem',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('li', kd, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  $d = /* @__PURE__ */ A(Sd, [['__scopeId', 'data-v-ff5045d7']]),
    ...
    setup(e) {
      ...
      return (g, c) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [renderSlot(g.$slots, 'default', {}, void 0, true)]),
            _: 3,
          },
          8,
          ['style'],
  ...
  ;(e > 1 && a.push({ type: 'direction', direction: 'left', pageNumber: e - 1 }),
    o > 1 &&
      ...
      o > 3
        ...
        : o !== 2 && a.push({ type: 'page', pageNumber: 2, isActive: e === 2 })))
  for (let r = o; r <= s; r++) a.push({ type: 'page', pageNumber: r, isActive: r === e })
  return (
    s + 1 < t &&
      (s + 1 !== t - 1
        ? a.push({ type: 'separator', pageNumber: 0 })
    ...
    s < t && a.push({ type: 'page', pageNumber: t, isActive: e === t }),
...
const wd = ['aria-label'],
  Ad = { class: 'agds-pagination__list' },
  Dd = ['href', 'aria-label'],
  Cd = {
    key: 0,
  ...
  Id = { class: 'agds-pagination__direction-label' },
  Md = {
    key: 1,
    class: 'agds-pagination__arrow',
    'aria-hidden': 'true',
  ...
  Ld = ['href', 'aria-label', 'aria-current'],
  Td = ['aria-label'],
  Fd = {
    key: 0,
  ...
  Vd = { class: 'agds-pagination__select-wrap' },
  Rd = ['value'],
  Ed = ['value'],
  Gd = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      const n = e,
        a = t,
        s = `agds-pagination-per-page-${getCurrentInstance()?.uid ?? 0}`,
        r = computed(() =>
          vn({
        ...
        u = computed(() => n.itemsPerPage !== void 0),
        g = computed(() => !!n.itemRangeText || u.value)
      function c(p, x) {
        return p.type === 'direction'
          ? p.direction
          : p.type === 'page'
            ? `page-${p.pageNumber}`
            : `separator-${x}`
      ...
      return (p, x) => (
        ...
        createElementBlock(
          'div',
          {
            class: normalizeClass([
              'agds-pagination',
              { 'agds-pagination--has-secondary': g.value },
            ]),
          },
          [
            createElementVNode(
                                    ...
                                    createElementVNode(
                                      ...
                                      [
                                        ...
                                        createElementVNode(
                                          ...
                                          Id,
                                          toDisplayString(
                                            h2.direction === 'left' ? 'Previous' : 'Next',
                                          ),
                                          1,
                                        ),
                                        h2.direction === 'right'
                                          ? (openBlock(),
                                            createElementBlock('svg', Md, [
                                              ...(x[1] ||
                                                (x[1] = [
                                                  createElementVNode(
                                                    'polyline',
            ...
            g.value
              ? (openBlock(),
                createElementBlock('div', Fd, [
                  e.itemRangeText
                    ? (openBlock(),
                      createElementBlock('p', Pd, toDisplayString(e.itemRangeText), 1))
                    : createCommentVNode('', true),
                  u.value
                    ? (openBlock(),
                      createElementBlock('div', Od, [
                        createElementVNode(
                          'label',
                          {
                            for: s,
  ...
  qd = /* @__PURE__ */ A(Gd, [['__scopeId', 'data-v-818e0963']]),
  zd = ['aria-label'],
  Hd = { class: 'agds-pagination__list' },
  Nd = ['aria-label', 'onClick'],
  jd = {
    key: 0,
    class: 'agds-pagination__arrow',
    'aria-hidden': 'true',
  ...
  Wd = { class: 'agds-pagination__direction-label' },
  Ud = {
    key: 1,
    class: 'agds-pagination__arrow',
    'aria-hidden': 'true',
  ...
  Kd = ['aria-label', 'aria-current', 'onClick'],
  Yd = ['aria-label'],
  Xd = {
    key: 0,
    class: 'agds-pagination__secondary',
  ...
  eu = { class: 'agds-pagination__select-wrap' },
  tu = ['value'],
  au = ['value'],
  nu = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      const g = computed(() =>
        ...
        c = computed(() => n.itemsPerPage !== void 0),
        f = computed(() => !!n.itemRangeText || c.value)
      function m(_, B) {
      ...
      function x(_) {
        ;(a('change', _.pageNumber),
          _.direction === 'left' && _.pageNumber === 1 && (r.value = true))
      }
      function h2(_) {
        a('change', _)
      }
      ...
      return (_, B) => (
        ...
        createElementBlock(
          'div',
          {
            class: normalizeClass([
              'agds-pagination',
              { 'agds-pagination--has-secondary': f.value },
            ]),
          },
          [
            createElementVNode(
                                    ...
                                    createElementVNode(
                                      ...
                                      [
                                        ...
                                        createElementVNode(
                                          ...
                                          Wd,
                                          toDisplayString(
                                            I.direction === 'left' ? 'Previous' : 'Next',
                                          ),
                                          1,
                                        ),
                                        I.direction === 'right'
                                          ? (openBlock(),
                                            createElementBlock('svg', Ud, [
                                              ...(B[1] ||
                                                (B[1] = [
                                                  createElementVNode(
                                                    'polyline',
            ...
            f.value
              ? (openBlock(),
                createElementBlock('div', Xd, [
                  e.itemRangeText
                    ? (openBlock(),
                      createElementBlock('p', Qd, toDisplayString(e.itemRangeText), 1))
                    : createCommentVNode('', true),
                  c.value
                    ? (openBlock(),
                      createElementBlock('div', Jd, [
                        createElementVNode(
                          'label',
                          {
                            for: s,
  ...
  ou = /* @__PURE__ */ A(nu, [['__scopeId', 'data-v-97c4d4de']]),
  su = { class: 'agds-modal__body' },
  lu = {
    key: 0,
  ...
  ru = /* @__PURE__ */ A(iu, [['__scopeId', 'data-v-bfa37f82']]),
  du = { class: 'agds-drawer__header' },
  uu = ['aria-label'],
  cu = {
    key: 0,
    ...
    setup(e, { emit: t }) {
      ...
      function f(m) {
        ...
        if (m.key === 'Tab') {
          ...
          const x = p[0],
            h2 = p[p.length - 1]
          m.shiftKey && (void 0).activeElement === x
            ? (m.preventDefault(), h2.focus())
            : !m.shiftKey && (void 0).activeElement === h2 && (m.preventDefault(), x.focus())
        }
      }
      return (m, p) => (
        openBlock(),
  ...
  fu = /* @__PURE__ */ A(gu, [['__scopeId', 'data-v-2624a4e4']]),
  mu = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      const n = e,
        ...
        o = ref('horizontal')
      return (
        provide('tabsBackground', n.background),
        provide('tabsContained', n.contained),
        (u, g) => (
          openBlock(),
          createBlock(
            unref(TabsRoot),
            ...
            {
              default: withCtx(() => [renderSlot(u.$slots, 'default', {}, void 0, true)]),
              _: 3,
            },
            8,
  ...
  vu = /* @__PURE__ */ A(mu, [['__scopeId', 'data-v-5acf89f8']]),
    ...
    setup(e) {
      ...
      return (n, a) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [renderSlot(n.$slots, 'default', {}, void 0, true)]),
            _: 3,
          },
          8,
          ['aria-label'],
  ...
  hu = /* @__PURE__ */ A(pu, [['__scopeId', 'data-v-c7938db0']]),
  bu = { class: 'agds-tab__label' },
    ...
    setup(e) {
      ...
      return (n, a) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [
              createElementVNode('span', bu, [renderSlot(n.$slots, 'default', {}, void 0, true)]),
  ...
  yu = /* @__PURE__ */ A(_u, [['__scopeId', 'data-v-a00ce61e']]),
    ...
    setup(e) {
      ...
      return (a, o) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [renderSlot(a.$slots, 'default', {}, void 0, true)]),
            _: 3,
          },
          8,
          ['value', 'class'],
  ...
  Su = /* @__PURE__ */ A(ku, [['__scopeId', 'data-v-075bd973']]),
  hn = /* @__PURE__ */ Symbol('CheckboxGroup'),
  $u = ['for'],
  xu = { class: 'agds-checkbox__control' },
  wu = [
    'id',
    'name',
    'checked',
  ...
  Cu = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n
      let s = 0
      const r = `agds-checkbox-${++s}`,
        u = computed(() => a.id ?? r),
        g = inject(hn, null),
        c = computed(() => a.name ?? g?.name ?? void 0),
        f = computed(() =>
        ...
        p = computed(() => a.disabled || (g?.disabled ?? false)),
        x = computed(() => (f.value && g?.messageId ? g.messageId : void 0)),
        h2 = ref(null)
      ...
      return (I, P) => (
        ...
        createElementBlock(
          'label',
          {
            ...
            class: normalizeClass([
              'agds-checkbox',
              [`agds-checkbox--${a.size}`, { 'agds-checkbox--disabled': p.value }],
            ]),
          },
          [
                ...
                createElementBlock(
                  'span',
                  {
                    ...
                    class: normalizeClass([
                      ...
                      { 'agds-checkbox__label--disabled': p.value },
                    ]),
                  },
  ...
  bn = /* @__PURE__ */ A(Cu, [['__scopeId', 'data-v-2d8ac97b']]),
  Iu = ['disabled'],
  Mu = {
    key: 0,
  ...
  Tu = ['id'],
  Fu = { class: 'agds-checkbox-group__items' },
  Pu = /* @__PURE__ */ defineComponent({
        ...
        (n, a) => (
          ...
          createElementBlock(
            'fieldset',
            {
              class: normalizeClass([
                'agds-checkbox-group',
                { 'agds-checkbox-group--invalid': t.invalid },
              ]),
              disabled: t.disabled || void 0,
            },
            [
              t.legend || n.$slots.legend
                ? (openBlock(),
                  createElementBlock('legend', Mu, [
                    renderSlot(
                      n.$slots,
                      'legend',
                      {},
                    ...
                    t.required
                      ? (openBlock(), createElementBlock('span', Bu, ' *'))
                      : createCommentVNode('', true),
                  ]))
                : createCommentVNode('', true),
              n.$slots.hint
                ? (openBlock(),
                  createElementBlock('div', Lu, [renderSlot(n.$slots, 'hint', {}, void 0, true)]))
                : createCommentVNode('', true),
              t.invalid && n.$slots.message
                ? (openBlock(),
                  createElementBlock(
                    'div',
                    {
                ...
                : createCommentVNode('', true),
              createElementVNode('div', Fu, [renderSlot(n.$slots, 'default', {}, void 0, true)]),
            ],
            10,
            Iu,
          )
  ...
  Ou = /* @__PURE__ */ A(Pu, [['__scopeId', 'data-v-f541f74a']]),
    ...
    setup(e) {
      return (t, n) => (
        ...
        createElementBlock(
          ...
          {
            class: normalizeClass([
              'agds-field-container',
              { 'agds-field-container--invalid': e.invalid },
            ]),
          },
          [renderSlot(t.$slots, 'default', {}, void 0, true)],
          2,
  ...
  Bt = /* @__PURE__ */ A(Vu, [['__scopeId', 'data-v-aeac4f4e']]),
  Ru = { class: 'agds-field-label__primary' },
  Eu = {
    key: 0,
    ...
    setup(e) {
      ...
      return (a, o) => (
        ...
        createBlock(
          ...
          {
            default: withCtx(() => [
              createElementVNode('span', Ru, [renderSlot(a.$slots, 'default', {}, void 0, true)]),
              n()
                ? (openBlock(), createElementBlock('span', Eu, toDisplayString(' ' + n()), 1))
                : createCommentVNode('', true),
            ]),
            _: 3,
          },
  ...
  Lt = /* @__PURE__ */ A(Gu, [['__scopeId', 'data-v-03e45694']]),
  qu = ['id'],
  ...
  Tt = /* @__PURE__ */ A(zu, [['__scopeId', 'data-v-4e1678bc']]),
  Hu = ['id'],
  Nu = { class: 'agds-field-message__text' },
      ...
      return (t, n) => (
        ...
        createElementBlock(
          ...
          [
            ...
            createElementVNode('span', Nu, [renderSlot(t.$slots, 'default', {}, void 0, true)]),
          ],
          8,
          Hu,
        )
  ...
  Ft = /* @__PURE__ */ A(ju, [['__scopeId', 'data-v-4ded11d3']]),
  Wu = /* @__PURE__ */ Symbol('ControlGroup'),
  Uu = ['aria-describedby'],
  Zu = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        a = computed(() => t.id ?? `control-group-${n}`),
        o = computed(() => `control-group-${n}-hint`),
        s = computed(() => `control-group-${n}-message`),
        r = computed(() => t.name ?? `control-group-${n}-name`),
        u = computed(() => {
          const g = []
          return (
            t.message && t.invalid && g.push(s.value),
            t.hint && g.push(o.value),
  ...
  mb = /* @__PURE__ */ A(Zu, [['__scopeId', 'data-v-da353d19']]),
  Ku = ['for'],
  Yu = ['id', 'name', 'checked', 'disabled', 'required', 'aria-invalid', 'aria-required'],
        ...
        createElementBlock(
          ...
          [
            ...
            createElementVNode(
              ...
              [
                ...(m[2] ||
                  (m[2] = [createElementVNode('span', { class: 'agds-switch__thumb' }, null, -1)])),
              ],
              2,
            ),
            f.$slots.default
  ...
  Qu = /* @__PURE__ */ A(Xu, [['__scopeId', 'data-v-bf048749']]),
  _n = /* @__PURE__ */ Symbol('RadioGroup'),
  Ju = ['for'],
  ec = { class: 'agds-radio__control' },
  tc = [
    'id',
    'name',
    'value',
        ...
        (B, I) => (
          ...
          createElementBlock(
            'label',
            {
              ...
              class: normalizeClass([
                'agds-radio',
                [`agds-radio--${a.size}`, { 'agds-radio--disabled': p.value }],
              ]),
            },
            [
                ...
                ? (openBlock(),
                  createElementBlock(
                    'span',
                    {
                      ...
                      class: normalizeClass([
                        'agds-radio__label',
                        { 'agds-radio__label--disabled': p.value },
                      ]),
                    },
                    [renderSlot(B.$slots, 'default', {}, void 0, true)],
                    2,
  ...
  nc = /* @__PURE__ */ A(ac, [['__scopeId', 'data-v-f9e45fdd']]),
  oc = ['disabled'],
  sc = {
    key: 0,
  ...
  rc = ['id'],
  dc = { class: 'agds-radio-group__items' },
        ...
        (n, a) => (
          ...
          createElementBlock(
            'fieldset',
            {
              class: normalizeClass([
                'agds-radio-group',
                { 'agds-radio-group--invalid': t.invalid },
              ]),
              disabled: t.disabled || void 0,
            },
            [
              t.legend || n.$slots.legend
                ? (openBlock(),
                  createElementBlock('legend', sc, [
                    ...
                    t.required
                      ? (openBlock(), createElementBlock('span', lc, ' *'))
                      : createCommentVNode('', true),
                  ]))
                : createCommentVNode('', true),
              n.$slots.hint
                ? (openBlock(),
                  createElementBlock('div', ic, [renderSlot(n.$slots, 'hint', {}, void 0, true)]))
                : createCommentVNode('', true),
              t.invalid && n.$slots.message
                ? (openBlock(),
                  createElementBlock(
                ...
                : createCommentVNode('', true),
              createElementVNode('div', dc, [renderSlot(n.$slots, 'default', {}, void 0, true)]),
            ],
            10,
            oc,
          )
  ...
  cc = /* @__PURE__ */ A(uc, [['__scopeId', 'data-v-758acbb9']]),
  gc = ['href', 'target', 'rel'],
  fc = {
    key: 0,
    class: 'sr-only',
      ...
      return (t, n) => (
        ...
        createElementBlock(
          ...
          [
            ...
            e.external
              ? (openBlock(), createElementBlock('span', fc, ', opens in a new tab'))
              : createCommentVNode('', true),
          ],
          42,
          gc,
  ...
  vc = /* @__PURE__ */ A(mc, [['__scopeId', 'data-v-51e5d28d']]),
  pc = ['type', 'disabled', 'aria-busy', 'aria-disabled'],
  hc = {
    'aria-live': 'assertive',
          ...
          [
            createElementVNode(
              'span',
              {
                class: normalizeClass([
                  'agds-cta__label',
                  { 'agds-cta__label--hidden': a.loading },
                ]),
              },
              [renderSlot(u.$slots, 'default', {}, void 0, true)],
              2,
  ...
  kc = /* @__PURE__ */ A(yc, [['__scopeId', 'data-v-44321ecd']]),
  Sc = ['href', 'target', 'rel'],
  $c = {
    key: 2,
    class: 'sr-only',
        ...
        createElementBlock(
          ...
          [
            ...
            e.direction !== 'left'
              ...
              : createCommentVNode('', true),
            e.external
              ? (openBlock(), createElementBlock('span', $c, ', opens in a new tab'))
              : createCommentVNode('', true),
          ],
          42,
          Sc,
  ...
  wc = /* @__PURE__ */ A(xc, [['__scopeId', 'data-v-43796b90']]),
  Ac = ['type', 'disabled', 'aria-busy', 'aria-disabled'],
  Dc = {
    'aria-live': 'assertive',
        ...
        createElementBlock(
          ...
          [
            ...
            createElementVNode('span', Dc, [
              a.loading
                ? (openBlock(),
                  createElementBlock('span', Cc, [
                    c[3] ||
                      (c[3] = createElementVNode(
                        'span',
                        {
  ...
  Bc = /* @__PURE__ */ A(Mc, [['__scopeId', 'data-v-14ff60bd']]),
  Lc = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = {
        ...
        n = e,
        a = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        o = computed(() => n.id ?? `field-${a}`),
        s = computed(() => `field-${a}-hint`),
        r = computed(() => `field-${a}-message`),
        u = computed(() => {
          const f = []
          return (
            n.message && n.invalid && f.push(r.value),
            n.hint && f.push(s.value),
        ...
        c = computed(() => (n.maxWidth ? t[n.maxWidth] : void 0))
      return (f, m) => (
        openBlock(),
        createBlock(
          Bt,
          ...
          },
          {
            default: withCtx(() => [
              ...
              n.hint
                ? (openBlock(),
                  createBlock(
                    ...
                    {
                      default: withCtx(() => [createTextVNode(toDisplayString(n.hint), 1)]),
                      _: 1,
                    },
                    8,
                    ['id'],
              ...
              n.message && n.invalid
                ? (openBlock(),
                  createBlock(
                    ...
                    {
                      default: withCtx(() => [createTextVNode(toDisplayString(n.message), 1)]),
                      _: 1,
                    },
                    8,
                    ['id'],
              ...
              renderSlot(
                f.$slots,
                'default',
                normalizeProps(guardReactiveProps(g.value)),
                void 0,
                true,
              ),
              c.value
...
function sa(e, t = '', n) {
  ...
  return e.filter((o) =>
    o.value.toLowerCase().includes(a) || o.label.toLowerCase().includes(a)
      ? n
        ? !n.some((r) => r.value === o.value && r.label === o.label)
        : true
      : false,
  )
}
const Tc = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        ...
        u = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        g = computed(() => a.id ?? `agds-combobox-${u}`),
        c = ref(''),
        f = computed(() => sa(a.options, c.value)),
        m = ref(null)
      return (
        ...
        (p, x) => (
          ...
          createBlock(
            ...
            {
              default: withCtx(
                ({ id: h2, 'aria-required': D, 'aria-invalid': _, 'aria-describedby': B }) => [
                  createVNode(
                    unref(ComboboxRoot),
                    {
                      modelValue: r.value,
                            ...
                            default: withCtx(() => [
                              createVNode(
                                unref(ComboboxInput),
                                {
                                  ...
                                  'display-value': (I) =>
                                    e.options.find((P) => P.value === I)?.label ?? '',
                                      ...
                                      default: withCtx(() => [
                                        createVNode(
                                          ...
                                          { class: 'agds-combobox__empty' },
                                          {
                                            default: withCtx(() => [
                                              createTextVNode(
                                                toDisplayString(e.emptyResultsMessage),
                                                1,
                                              ),
                                            ]),
                                            _: 1,
  ...
  Fc = /* @__PURE__ */ A(Tc, [['__scopeId', 'data-v-da8ebd62']]),
  Pc = {
    key: 0,
    class: 'agds-combobox-multi__tags',
    'aria-label': 'Selected items',
  },
  Oc = { class: 'agds-combobox-multi__tag-label' },
  Vc = ['aria-label', 'disabled', 'onMousedown'],
  Rc = {
    'aria-live': 'polite',
    'aria-atomic': 'true',
    class: 'sr-only',
  ...
  Ec = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        ...
        u = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        g = computed(() => a.id ?? `agds-combobox-multi-${u}`),
        c = ref(''),
        f = computed(() => sa(a.options, c.value, s.value)),
        m = ref('')
      let p = 0
      watch(
        s,
        (D, _) => {
          ...
          } else if (D.length === 0 && p > 0) m.value = 'All items have been removed.'
      ...
      const h2 = ref(null)
      return (
        t({ focus: () => h2.value?.querySelector('input')?.focus() }),
        (D, _) => (
          openBlock(),
          createBlock(
            Pe,
            ...
            {
              default: withCtx(
                ({ id: B, 'aria-required': I, 'aria-invalid': P, 'aria-describedby': H }) => [
                  createVNode(
                    unref(ComboboxRoot),
                    {
                      modelValue: r.value,
                      ...
                      class: normalizeClass([
                        'agds-combobox-multi',
                        { 'agds-combobox-multi--block': e.block },
                      ]),
                    },
                    {
                      default: withCtx(() => [
  ...
  Gc = /* @__PURE__ */ A(Ec, [['__scopeId', 'data-v-1ba80f33']]),
  qc = {
    key: 0,
  ...
  Zc = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        ...
        u = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        g = computed(() => a.id ?? `agds-combobox-async-${u}`),
        c = ref(null),
        f = shallowRef([]),
        m = ref(false),
        p = ref(false),
      ...
      let _ = null
      const B = {},
        I = computed(() => p.value || !!a.loading),
        P = ref(''),
        H = computed(() => a.clearable && (s.value != null || P.value.length > 0))
      function Y(Q) {
        Q || (m.value = false)
      }
      function U(Q) {
          ...
          ;((f.value = B[Z]),
            ...
            (D.value =
              B[Z].length === 0
                ...
                : `${B[Z].length} result${B[Z].length === 1 ? '' : 's'} available`))
          return
        }
        try {
          ...
          ;((B[Z] = q),
            ...
            (D.value =
              q.length === 0
                ? a.emptyResultsMessage
                : `${q.length} result${q.length === 1 ? '' : 's'} available`))
        } catch {
      ...
      function O(Q) {
        ...
        if (
          ((P.value = Z),
          s.value != null && Z !== s.value.label && (s.value = null),
          _ && clearTimeout(_),
          !Z.trim())
        ) {
          ;((f.value = []),
      ...
      function le() {
        ...
        else if (f.value.length > 0 || p.value || x.value) m.value = true
        else {
      ...
      return (
        t({ focus: () => N()?.querySelector('input')?.focus() }),
        (Q, Z) => (
          openBlock(),
          createBlock(
            Pe,
            ...
            {
              default: withCtx(
                ({ id: q, 'aria-required': re, 'aria-invalid': me, 'aria-describedby': he }) => [
                  createVNode(
                    unref(ComboboxRoot),
                    {
                      modelValue: r.value,
                      ...
                      class: normalizeClass([
                        'agds-combobox-async',
                        { 'agds-combobox-async--block': e.block },
                      ]),
                      'onUpdate:open': Y,
                    },
                    {
                        ...
                        createVNode(
                          ...
                          },
                          {
                            default: withCtx(() => [
                              ...
                              I.value
                                ? (openBlock(), createElementBlock('span', qc))
                                : createCommentVNode('', true),
                              H.value && !I.value
                                ? (openBlock(),
                                  createElementBlock(
                                ...
                                : createCommentVNode('', true),
                              H.value && e.showDropdownTrigger && !I.value
                                ? (openBlock(), createElementBlock('span', zc))
                                : createCommentVNode('', true),
                                  ...
                                  createElementBlock(
                                    'button',
                                    {
                                      ...
                                      class: normalizeClass([
                                        ...
                                        { 'agds-combobox-async__btn--open': m.value },
                                      ]),
                                        ...
                                        p.value
                                          ? (openBlock(),
                                            createElementBlock(
                                              'li',
                                              Nc,
                                              toDisplayString(e.loadingLabel),
                                              1,
                                            ))
                                          : x.value
                                            ? (openBlock(),
  ...
  yn = /* @__PURE__ */ A(Zc, [['__scopeId', 'data-v-9ed5ef8c']]),
  Kc = {
    key: 0,
    class: 'agds-combobox-async-multi__tags',
    'aria-label': 'Selected items',
  },
  Yc = { class: 'agds-combobox-async-multi__tag-label' },
  Xc = ['aria-label', 'disabled', 'onMousedown'],
  Qc = [
    'id',
    'aria-expanded',
    'aria-controls',
  ...
  ng = ['id', 'aria-selected', 'onMousedown', 'onMousemove'],
  og = {
    'aria-live': 'polite',
    'aria-atomic': 'true',
    class: 'sr-only',
  ...
  lg = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = useModel(e, 'modelValue'),
        r = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        u = computed(() => a.id ?? `agds-combobox-async-multi-${r}`),
        g = computed(() => `${u.value}-listbox`),
        c = ref(null),
        f = ref(''),
        m = shallowRef([]),
        p = ref(false),
        ...
        B = ref('')
      let I = null
      const P = computed(() => x.value || !!a.loading),
        H = computed(() => (h2.value >= 0 ? `${g.value}-option-${h2.value}` : void 0))
      let Y = 0
      watch(
        s,
        (q, re) => {
          ...
          } else if (q.length === 0 && Y > 0) B.value = 'All items have been removed.'
      ...
      async function U(q) {
        ...
        try {
          const re = await a.fetchOptions(q),
            me = sa(re, q, s.value)
          ;((m.value = me),
            (p.value = true),
            (h2.value = -1),
            (_.value =
              me.length === 0
                ? a.emptyResultsMessage
                : `${me.length} result${me.length === 1 ? '' : 's'} available`))
        } catch {
          ;((m.value = []), (_.value = ''))
        } finally {
          x.value = false
      ...
      function O(q) {
        ;(s.value.some((re) => re.value === q.value) || (s.value = [...s.value, q]),
          (f.value = ''),
          (m.value = m.value.filter((re) => re.value !== q.value)),
          (p.value = m.value.length > 0),
          (h2.value = -1),
          c.value?.focus())
      }
      function V(q) {
      ...
      function le(q) {
        switch (q.key) {
          case 'ArrowDown':
            ;(q.preventDefault(),
              !p.value && m.value.length > 0 && (p.value = true),
              m.value.length > 0 && (h2.value = (h2.value + 1) % m.value.length))
            break
          case 'ArrowUp':
            ;(q.preventDefault(),
              !p.value && m.value.length > 0 && (p.value = true),
              m.value.length > 0 && (h2.value = h2.value <= 0 ? m.value.length - 1 : h2.value - 1))
            break
          case 'Enter':
            ;(q.preventDefault(),
              p.value && h2.value >= 0
                ? O(m.value[h2.value])
                : p.value && m.value.length > 0 && O(m.value[0]))
            break
          case 'Escape':
      ...
      return (
        ...
        (q, re) => (
          ...
          createBlock(
            ...
            {
              default: withCtx(
                ({ id: me, 'aria-required': he, 'aria-invalid': ce, 'aria-describedby': De }) => [
                  createElementVNode(
                    'div',
                    {
                      class: normalizeClass([
                    ...
                    [
                      createElementVNode(
                        ...
                        [
                          ...
                          P.value
                            ? (openBlock(), createElementBlock('span', Jc))
                            : createCommentVNode('', true),
                        ],
                        2,
                      ),
                      withDirectives(
                        createElementVNode(
                          ...
                          [
                            x.value
                              ? (openBlock(),
                                createElementBlock('li', tg, toDisplayString(e.loadingLabel), 1))
                              : D.value && m.value.length === 0
                                ? (openBlock(),
                                  createElementBlock(
                                    'li',
                                    ag,
                                      ...
                                      (ve, Le) => (
                                        ...
                                        createElementBlock(
                                          'li',
                                          {
                                            ...
                                            key: ve.value,
                                            role: 'option',
                                            'aria-selected': s.value.some(
                                              (Me) => Me.value === ve.value,
                                            ),
                                            class: normalizeClass([
  ...
  ig = /* @__PURE__ */ A(lg, [['__scopeId', 'data-v-af8f2302']]),
  ...
  dg = { class: 'agds-calendar__months' },
  ug = { class: 'agds-calendar__caption' },
  cg = ['disabled', 'aria-label'],
  gg = {
    key: 1,
  ...
  vg = { class: 'agds-calendar__select-wrap' },
  pg = ['for'],
  hg = ['id', 'value'],
  bg = ['value'],
  _g = { class: 'agds-calendar__select-wrap' },
  yg = ['for'],
  kg = ['id', 'value'],
  Sg = ['value'],
  $g = {
  ...
  Dg = ['aria-label'],
  Cg = ['abbr'],
  Ig = ['onClick', 'onKeydown', 'onMouseenter', 'onFocus'],
  Mg = {
  ...
  Bg = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      function o(R, j) {
        return (
          R.getFullYear() === j.getFullYear() &&
          R.getMonth() === j.getMonth() &&
          R.getDate() === j.getDate()
        )
      }
      function s(R, j) {
      ...
      function u(R, j) {
        const W = new Date(R, j, 1).getDay(),
          ae = W === 0 ? 6 : W - 1,
          ne = []
        for (let te = ae; te > 0; te--) ne.push(new Date(R, j, 1 - te))
        const ue = new Date(R, j + 1, 0).getDate()
        for (let te = 1; te <= ue; te++) ne.push(new Date(R, j, te))
        for (; ne.length < 42; ) {
      ...
      const c = e,
        f = n,
        m = a(/* @__PURE__ */ new Date())
      function p() {
        let R
        c.defaultMonth
          ? (R = c.defaultMonth)
          : c.mode === 'single' && c.selectedDate
            ? (R = c.selectedDate)
            : c.mode === 'range'
              ? c.inputMode === 'to' && c.selectedTo
                ? (R = c.selectedTo)
                : c.selectedFrom
                  ? (R = c.selectedFrom)
                  : (R = m)
      ...
      function Y() {
        const R = c.yearRange?.from ?? H - 10,
          j = c.yearRange?.to ?? H + 10,
          L = []
      ...
      function N(R, j) {
        const L = a(R),
          W = o(L, m),
          ae = R.getMonth() !== P.value[j].month,
          ne = V(R)
        let ue = false,
          te = false,
          Ne = false,
          Oe = false
        if (c.mode === 'single') ue = !!(c.selectedDate && o(L, c.selectedDate))
        else {
          const Te = c.selectedFrom ? a(c.selectedFrom) : null,
            G = c.selectedTo ? a(c.selectedTo) : null,
            z = _.value ? a(_.value) : null
      ...
      function ce(R, j) {
        ...
        if (L) {
          ...
          const W = P.value[0],
            ae = P.value[P.value.length - 1]
          ;(L.getFullYear() < W.year || (L.getFullYear() === W.year && L.getMonth() < W.month)
            ? Q()
            : (L.getFullYear() > ae.year ||
                (L.getFullYear() === ae.year && L.getMonth() > ae.month)) &&
              Z(),
            nextTick(() => he(L)))
        }
      }
      function De() {
        nextTick(() => {
          ...
          ;(c.mode === 'single'
            ? (R = c.selectedDate ?? m)
            : (R = (c.inputMode === 'to' ? c.selectedTo : c.selectedFrom) ?? m),
            (B.value = R),
            he(R))
        })
      }
      ...
      function ve(R, j) {
        const L = u(R, j),
          W = []
        for (let ae = 0; ae < 6; ae++) W.push(L.slice(ae * 7, ae * 7 + 7))
        return W
      }
      const Le = computed(() =>
          c.minDate ? new Date(h2.value, D.value, 0) >= a(c.minDate) : true,
        ),
        Me = computed(() => {
      ...
      return (R, j) => (
        ...
        createElementBlock(
          'div',
          {
            ...
            class: normalizeClass([
              'agds-calendar',
              { 'agds-calendar--range': e.mode === 'range' },
            ]),
          },
          [
                      ...
                      [
                        createElementVNode('div', ug, [
                          W === 0
                            ...
                            : (openBlock(), createElementBlock('span', gg)),
                            ...
                            e.yearRange || W === 0
                                    ...
                                    W === 0
                                      ...
                                      : (openBlock(),
                                        createElementBlock(
                                          'span',
                                          $g,
                                          toDisplayString(U[L.month]) +
                                            ' ' +
                                            toDisplayString(L.year),
                                          1,
                                        )),
                                  ],
                                  64,
                              ...
                              : (openBlock(),
                                createElementBlock(
                                  'span',
                                  xg,
                                  toDisplayString(U[L.month]) + ' ' + toDisplayString(L.year),
                                  1,
                                )),
                          ]),
                          W === P.value.length - 1
                            ...
                            : (openBlock(), createElementBlock('span', Ag)),
                        ]),
                        createElementVNode(
                          'table',
                          {
  ...
  Ba = /* @__PURE__ */ A(Bg, [['__scopeId', 'data-v-a54dc765']]),
  Lg = {
    key: 0,
  ...
  Eg = ['disabled', 'aria-expanded', 'aria-label'],
  Gg = {
    key: 0,
    class: 'agds-datepicker__optional',
  },
  qg = ['id'],
  zg = ['id'],
  Hg = { class: 'agds-datepicker__range-row' },
  Ng = ['for'],
  jg = {
    class: 'agds-datepicker__secondary-label',
    'aria-hidden': 'true',
  ...
  Ug = ['disabled', 'aria-expanded', 'aria-label'],
  Zg = ['for'],
  Kg = {
    class: 'agds-datepicker__secondary-label',
    'aria-hidden': 'true',
  ...
  Xg = ['disabled', 'aria-expanded', 'aria-label'],
  Qg = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      function c(G, z, X, ie, Ve) {
        if (G === 'from')
          return z && X && z > X
            ? g(X, Ve === 2 ? 1 : 0)
            : z || (X ? g(X, Ve === 2 ? 1 : 0) : void 0)
        if (G === 'to') return z && X && X < z ? z : X ? g(X, Ve === 2 ? 1 : 0) : z || void 0
        if (ie) {
          const Ge = new Date(ie.from, 0, 1),
            je = new Date(ie.to, 11, 31),
            We = Date.now()
      ...
      const f = e,
        m = n,
        p = useId(),
        x = computed(() => f.id ?? `agds-datepicker-${p}`),
        h2 = computed(() => `agds-datepicker-${p}-from`),
        D = computed(() => `agds-datepicker-${p}-to`),
        _ = computed(() => `agds-datepicker-${p}-hint`),
        B = computed(() => `agds-datepicker-${p}-message`),
        I = computed(() => (!f.required && !f.hideOptionalLabel ? ' (optional)' : '')),
        P = computed(() => (f.range ? null : (f.modelValue ?? null))),
        H = computed(() =>
          f.range ? (f.modelValue ?? { from: null, to: null }) : { from: null, to: null },
        )
      function Y(G) {
        return G ? o(G, f.dateFormat) : ''
      }
      const U = ref(Y(P.value)),
        se = ref(Y(H.value.from)),
        O = ref(Y(H.value.to))
      ;(watch(P, (G) => {
        U.value = Y(G)
      }),
      ...
      const Me = ref(0)
      const j = computed(() => (f.range && Me.value >= 768 ? 2 : 1)),
        L = computed(() =>
          f.range
            ? c(N.value, H.value.from, H.value.to, f.yearRange, j.value)
            : (P.value ?? void 0),
        )
      function W(G) {
        if (!f.range) {
        ...
        if (
          (N.value === 'from'
            ? ((X = G), ie && X > ie && (ie = null))
            : N.value === 'to' && ((ie = G), X && ie < X && ([X, ie] = [ie, X])),
          m('update:modelValue', { from: X, to: ie }),
          N.value === 'from' && !ie)
        ) {
                ...
                [
                  createElementVNode(
                    ...
                    [
                      ...
                      I.value
                        ? (openBlock(), createElementBlock('span', Gg, toDisplayString(I.value), 1))
                        : createCommentVNode('', true),
                    ],
                    2,
                  ),
                                ...
                                createElementVNode(
                                  ...
                                  [
                                    ...
                                    createElementVNode(
                                      ...
                                      jg,
                                      toDisplayString(
                                        u(e.minDate ?? /* @__PURE__ */ new Date(), e.dateFormat),
                                      ),
                                      1,
                                    ),
                                    createElementVNode(
                                ...
                                createElementVNode(
                                  ...
                                  [
                                    ...
                                    createElementVNode(
                                      ...
                                      Kg,
                                      toDisplayString(
                                        u(e.maxDate ?? /* @__PURE__ */ new Date(), e.dateFormat),
                                      ),
                                      1,
                                    ),
                                    createElementVNode(
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(PopoverContent),
                              {
                                ...
                                'aria-modal': 'true',
                                onOpenAutoFocus:
                                  z[6] || (z[6] = withModifiers(() => {}, ['prevent'])),
                                onEscapeKeyDown:
                                  z[7] || (z[7] = withModifiers(() => {}, ['prevent'])),
                              },
                              {
                                default: withCtx(() => [
                                  createVNode(
                  ...
                  [
                    createElementVNode(
                      ...
                      [
                        ...
                        I.value
                          ? (openBlock(),
                            createElementBlock('span', Fg, toDisplayString(I.value), 1))
                          : createCommentVNode('', true),
                      ],
                      8,
                      Tg,
                    ...
                    createElementVNode(
                      ...
                      Pg,
                      toDisplayString(
                        u(e.minDate ?? e.maxDate ?? /* @__PURE__ */ new Date(), e.dateFormat),
                      ),
                      1,
                    ),
                    e.hint
                              ...
                              default: withCtx(() => [
                                createElementVNode(
                                  'div',
                                  {
                                    class: normalizeClass([
                                      'agds-datepicker__input-row',
                                      { 'agds-datepicker__input-row--open': V.value },
                                    ]),
                                  },
                                  [
                                    createElementVNode(
                            ...
                            default: withCtx(() => [
                              createVNode(
                                unref(PopoverContent),
                                {
                                  ...
                                  'aria-modal': 'true',
                                  onOpenAutoFocus:
                                    z[1] || (z[1] = withModifiers(() => {}, ['prevent'])),
                                  onEscapeKeyDown:
                                    z[2] || (z[2] = withModifiers(() => {}, ['prevent'])),
                                },
                                {
                                  default: withCtx(() => [
                                    createVNode(
...
function tf(e, t) {
  ;(t.tagName.toLowerCase() === 'div' ? t.querySelector('input')?.focus() : t.focus(),
    ((void 0).querySelector(`label[for="${e}"]`)?.parentElement ?? t).scrollIntoView({
      block: 'nearest',
    }))
}
const af = ['id', 'aria-describedby'],
  nf = { class: 'agds-fieldset__legend' },
  of = ['id'],
  sf = { class: 'agds-fieldset__content' },
  lf = /* @__PURE__ */ defineComponent({
    __name: 'AGDSFieldset',
    props: {
      legend: {},
      hint: {},
    ...
    setup(e) {
      const t = e,
        n = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        a = computed(() => t.id ?? `fieldset-${n}`),
        o = computed(() => `fieldset-${n}-hint`)
      return (s, r) => (
        openBlock(),
        createElementBlock(
          'fieldset',
          ...
          [
            ...
            e.hint
              ...
              : createCommentVNode('', true),
            createElementVNode('div', sf, [renderSlot(s.$slots, 'default', {}, void 0, true)]),
          ],
          8,
          af,
        )
  ...
  rf = /* @__PURE__ */ A(lf, [['__scopeId', 'data-v-481ea791']]),
  df = { class: 'agds-grouped-fields' },
  uf = {
  ...
  cf = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        a = computed(() => `grouped-fields-${n}-hint`),
        o = computed(() => `grouped-fields-${n}-message`),
        s = computed(() => t.field1Invalid || t.field2Invalid)
      function r(c) {
        const f = []
        return (
          c && t.message && f.push(o.value),
          t.hint && f.push(a.value),
              ...
              createElementVNode('fieldset', df, [
                createVNode(
                  Lt,
                  {
                    as: 'legend',
                    class: normalizeClass({
                      'agds-grouped-fields__legend--hidden': e.visuallyHideLegend,
                    }),
                    'hide-optional-label': e.hideOptionalLabel,
                    required: false,
                  },
                  {
                    default: withCtx(() => [createTextVNode(toDisplayString(e.legend), 1)]),
                    _: 1,
                  },
                  8,
                    ...
                    e.hint
                      ? (openBlock(),
                        createBlock(
                          ...
                          {
                            default: withCtx(() => [createTextVNode(toDisplayString(e.hint), 1)]),
                            _: 1,
                          },
                          8,
                          ['id'],
  ...
  gf = /* @__PURE__ */ A(cf, [['__scopeId', 'data-v-a8f21ded']]),
  pb = 'data-grouped-fields',
  ff = ['for'],
  mf = {
    key: 0,
  ...
  vf = ['id'],
  pf = ['id'],
  hf = ['accept', 'capture', 'disabled', 'multiple', 'name'],
  bf = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = {
        ...
        s = n,
        r = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        u = computed(() => o.id ?? `agds-file-input-${r}`),
        g = computed(() => `${u.value}-hint`),
        c = computed(() => `${u.value}-message`),
        f = ref([]),
        m = computed(() => f.value.length > 0)
      function p(le) {
        const Q = le.target
        ;(Q.files && (f.value = Array.from(Q.files).map((Z) => Z.name)), s('change', le))
      }
      const x = computed(() => {
          if (o.accept) return Array.isArray(o.accept) ? o.accept.join(',') : o.accept
        }),
        h2 = computed(() => {
          if (!o.accept) return
      ...
      function B(le) {
        return f.value.length === 0
          ? `No ${_.value} selected`
          : f.value.length === 1
            ? `${f.value[0]}${le ? '' : ' selected'}`
            : `${f.value.length} files selected`
      }
      const I = computed(() => B(true)),
        P = computed(() => B(false)),
        H = computed(() => `Select ${_.value}`),
        Y = computed(() => {
          if (!(o.required || o.hideOptionalLabel)) return '(optional)'
        }),
        U = computed(() =>
          [
            H.value,
        ...
        se = computed(() => {
          const le = []
          return (
            D.value && le.push(g.value),
            o.message && le.push(c.value),
            le.length ? le.join(' ') : void 0
          )
        }),
        O = ref(null),
        V = ref(null)
          ...
          default: withCtx(() => [
            createElementVNode(
              ...
              [
                ...
                Y.value
                  ? (openBlock(), createElementBlock('span', mf, toDisplayString(Y.value), 1))
                  : createCommentVNode('', true),
              ],
              8,
              ff,
              ...
              },
              {
                default: withCtx(() => [
                  createVNode(
                    ...
                    {
                      default: withCtx(() => [createTextVNode(toDisplayString(H.value), 1)]),
                      _: 1,
                    },
                    8,
                  ...
                  createElementVNode(
                    'span',
                    {
                      class: normalizeClass([
                        ...
                        { 'agds-file-input__file-name--populated': m.value },
                      ]),
                      'aria-hidden': 'true',
                    },
                ...
                createElementBlock(
                  'span',
                  {
                    ...
                    class: normalizeClass([
                      ...
                      { 'agds-file-input__message--invalid': o.invalid },
                    ]),
                    role: 'alert',
                  },
                  toDisplayString(o.message),
                  11,
                  pf,
                ))
              : createCommentVNode('', true),
  ...
  hb = /* @__PURE__ */ A(bf, [['__scopeId', 'data-v-0bfcf206']]),
  _f = ['href'],
  yf = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTextLink',
    props: {
      href: {},
      focusRingFor: { default: 'keyboard' },
  ...
  Pt = /* @__PURE__ */ A(yf, [['__scopeId', 'data-v-4c648a8d']]),
  kf = {
    key: 1,
  ...
  kn = /* @__PURE__ */ A(Sf, [['__scopeId', 'data-v-7be25cc3']]),
  Sn = 'file-too-large',
  $n = 'file-invalid-type',
  $f = 'too-many-files',
  xn = {
...
function Je(e) {
  ...
  const n = t < 0
  n && (t = -t)
  const a = wf(Math.floor(Math.log(t) / Math.log(Et)), 0, La),
    o = t / Math.pow(Et, a),
    s = Math.pow(10, a > 0 ? 2 : 0)
  ...
  return (
    t &&
      (Object.keys(t).some((s) => {
        ...
        a.push({ code: $n, message: 'File type not accepted' })),
    n > 0 && e.size > n && a.push({ code: Sn, message: 'File is too large' }),
    a
  )
}
const Tf = {
  ...
  Ff = { class: 'agds-file-upload-file__info' },
  Pf = {
    key: 0,
  ...
  Of = { class: 'agds-file-upload-file__name' },
  Vf = {
    key: 0,
    class: 'agds-file-upload-file__size',
  },
  Rf = { class: 'agds-file-upload-file__actions' },
  Ef = {
    key: 0,
  ...
  Gf = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => t.file.status ?? 'none'),
        a = computed(() => If(t.file))
      const o = computed(() => (t.file.size ? ` (${Je(t.file.size)})` : ''))
      return (s, r) => (
        openBlock(),
        createElementBlock(
          'li',
                  ...
                  ? (openBlock(),
                    createBlock(
                      ...
                      },
                      {
                        default: withCtx(() => [
                          createTextVNode(
                            toDisplayString(e.file.name) + toDisplayString(o.value),
                            1,
                          ),
                        ]),
                        _: 1,
                        ...
                        e.file.size
                          ? (openBlock(),
                            createElementBlock(
                              'span',
                              Vf,
                              ' (' + toDisplayString(unref(Je)(e.file.size)) + ')',
                              1,
                            ))
                          : createCommentVNode('', true),
                      ],
                ...
                : (openBlock(),
                  createBlock(
                    ...
                    },
                    {
                      ...
                      default: withCtx(() => [r[3] || (r[3] = createTextVNode(' Remove ', -1))]),
                      _: 1,
                    },
                    8,
                    ['aria-label', 'onClick'],
  ...
  qf = /* @__PURE__ */ A(Gf, [['__scopeId', 'data-v-711952d3']]),
  zf = { class: 'agds-file-upload-existing-file' },
  Hf = {
    key: 0,
    class: 'agds-file-upload-existing-file__thumb-wrapper',
  },
  Nf = { class: 'agds-file-upload-existing-file__info' },
  jf = { class: 'agds-file-upload-existing-file__name' },
  Wf = {
    key: 0,
    class: 'agds-file-upload-existing-file__size',
  },
  Uf = { class: 'agds-file-upload-existing-file__actions' },
  Zf = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => (t.file.size ? ` (${Je(t.file.size)})` : ''))
      return (a, o) => (
        openBlock(),
        createElementBlock('li', zf, [
          e.hideThumbnails
            ? createCommentVNode('', true)
            : (openBlock(),
              createElementBlock('div', Hf, [
                createVNode(
                  kn,
                  {
          ...
          createElementVNode('div', Uf, [
            createVNode(
              ...
              },
              {
                ...
                default: withCtx(() => [o[3] || (o[3] = createTextVNode(' Remove ', -1))]),
                _: 1,
              },
              8,
              ['aria-label', 'onClick'],
  ...
  Kf = /* @__PURE__ */ A(Zf, [['__scopeId', 'data-v-e80881ab']]),
  Yf = { class: 'agds-file-upload__stack' },
  Xf = {
    role: 'status',
    class: 'sr-only',
    'aria-live': 'polite',
  ...
  Qf = ['accept', 'multiple', 'disabled', 'name'],
  Jf = { class: 'agds-file-upload__instructions' },
  em = {
    key: 0,
  ...
  om = { class: 'agds-file-upload__error-header' },
  sm = { class: 'agds-file-upload__error-title' },
  lm = { class: 'agds-file-upload__error-intro' },
  im = { class: 'agds-file-upload__error-list' },
  rm = { class: 'agds-file-upload__error-filename' },
  dm = { class: 'agds-file-upload__error-size' },
  um = {
    key: 1,
  ...
  mm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `file-upload-${s}`),
        u = computed(() => (a.maxSize ? `${r.value}-size-desc` : '')),
        g = computed(() => (a.accept?.length ? `${r.value}-accept-desc` : '')),
        c = computed(() => {
        ...
        m = computed(() => (a.maxSize && !isNaN(a.maxSize) ? a.maxSize * 1e3 : 0)),
        p = computed(() => Je(m.value)),
        x = computed(() => {
        ...
        h2 = ref([]),
        D = ref([]),
        _ = computed(() => h2.value.length > 0 || D.value.length > 0),
        B = computed(() => [...h2.value, ...D.value]),
      ...
      function Y(L) {
        ...
        let ne
        if (a.multiple) {
          const ue = [...a.modelValue, ...W],
            te = Object.values(
              ue.reduce((Ne, Oe) => ({ ...Ne, [`${Oe.name}-${Oe.size}-${Oe.type}`]: Oe }), {}),
            )
          x.value && te.length > x.value
            ? ((D.value = te.slice(x.value).map(Mf)), (ne = te.slice(0, x.value)))
            : (ne = te)
        } else ne = [W[0]]
        ;((H.value = ne.map((ue) => ue.name).join(', ') + ' added'), o('update:modelValue', ne))
      }
      const U = ref(0),
        se = computed(() => U.value > 0)
      function O(L) {
      ...
      const ce = computed(() => Af([...a.modelValue, ...a.existingFiles])),
        De = computed(() => a.modelValue.length > 0 || a.existingFiles.length > 0),
        ve = computed(() => Df(a.accept)),
        Le = computed(() => (a.multiple ? 'files' : 'file')),
        Me = computed(() => `Select ${Le.value}`),
        R = computed(() => (a.required || a.hideOptionalLabel ? void 0 : '(optional)')),
        j = computed(() =>
          [
            Me.value,
            a.label,
            ...
            },
            {
              default: withCtx((ae) => [
                createElementVNode('div', Yf, [
                    ...
                    [
                        ...
                        createElementVNode(
                          'span',
                          {
                            class: normalizeClass([
                              ...
                              { 'agds-file-upload__drag-text--hidden': se.value },
                            ]),
                          },
                          toDisplayString(
                            a.multiple
                        ...
                        se.value
                          ? (openBlock(),
                            createElementBlock(
                              'span',
                              em,
                              ' Drop ' + toDisplayString(Le.value) + ' here… ',
                              1,
                            ))
                          : createCommentVNode('', true),
                        a.maxSize
                          ? (openBlock(),
                            createElementBlock(
                              ...
                              toDisplayString(a.multiple ? 'Each file' : 'File') +
                                ' cannot exceed ' +
                        ...
                        ve.value
                          ? (openBlock(),
                            createElementBlock(
                              ...
                              ' Files accepted: ' + toDisplayString(ve.value) + '. ',
                              9,
                              am,
                            ))
                          : createCommentVNode('', true),
                      ...
                      createVNode(
                        Ue,
                        {
                          ...
                          'aria-label': j.value,
                          'aria-describedby':
                            [ae['aria-describedby'], u.value, g.value].filter(Boolean).join(' ') ||
                            void 0,
                          'focus-ring-for': 'all',
                          onClick: q,
                        ...
                        {
                          default: withCtx(() => [createTextVNode(toDisplayString(Me.value), 1)]),
                          _: 1,
                        },
                        8,
                  ...
                  _.value
                    ? (openBlock(),
                      createElementBlock('div', nm, [
                        createElementVNode('div', om, [
                          createElementVNode(
                            'span',
                            sm,
                            ' The following ' +
                              toDisplayString(I.value ? 'files' : 'file') +
                                ...
                                createElementBlock(
                                  ...
                                  [
                                    createElementVNode(
                                      'span',
                                      rm,
                                      toDisplayString(ne.file.name),
                                      1,
                                    ),
                                    createElementVNode(
                                      'span',
                                      dm,
                                      ' (' + toDisplayString(unref(Je)(ne.file.size)) + ')',
                                      1,
                                    ),
                                    createElementVNode(
                                      'span',
                                      null,
                                      ' — ' + toDisplayString(unref(Cf)(ne.errors, p.value)),
                                      1,
                                    ),
                                  ],
                                )
                  ...
                  De.value
                    ? (openBlock(),
                      createElementBlock('div', um, [
                        ce.value
                          ? (openBlock(), createElementBlock('p', cm, toDisplayString(ce.value), 1))
                          : createCommentVNode('', true),
                        a.existingFiles.length
                          ? (openBlock(),
                            createElementBlock('ul', gm, [
                              (openBlock(true),
                              createElementBlock(
                                Fragment,
                                null,
  ...
  vm = /* @__PURE__ */ A(mm, [['__scopeId', 'data-v-af7c3074']]),
  pm = [
    'type',
    'name',
    'disabled',
  ...
  hm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `text-input-${s}`),
        u = ref(null),
        g = ref(a.modelValue ?? ''),
        c = computed(() => (a.modelValue !== void 0 ? a.modelValue : g.value))
      function f(x) {
      ...
      const m = {
        ...
        p = computed(() => (a.block ? { width: '100%' } : { maxWidth: m[a.maxWidth] }))
      return (
  ...
  bm = /* @__PURE__ */ A(hm, [['__scopeId', 'data-v-96ab7024']]),
  _m = ['h:mm aaa', 'h:mm aa', 'HH:mm', 'hh:mm aaa', 'hh:mm aa']
function ym(e) {
  if (!e) return null
  const t = e.toLowerCase().trim(),
    n = t.endsWith('pm'),
    a = t.endsWith('am'),
    o = t.replace(/[ap]m$/, '').replace(/\W/g, '')
  if (!o) return null
  let s, r
  if (o.length <= 2) ((s = parseInt(o, 10)), (r = 0))
  else if (o.length === 3) ((s = parseInt(o.slice(0, 1), 10)), (r = parseInt(o.slice(1), 10)))
  else if (o.length === 4) ((s = parseInt(o.slice(0, 2), 10)), (r = parseInt(o.slice(2), 10)))
  else return null
  return isNaN(s) ||
    isNaN(r) ||
    (n && s !== 12 && s < 12 && (s += 12), a && s === 12 && (s = 0), s < 0 || s > 24) ||
    r < 0 ||
    r > 59
    ? null
    : { hours: s, minutes: r }
...
function Ye(e, t) {
  ...
  switch (t) {
    ...
    case 'hh:mm aaa': {
      const r = String(a % 12 || 12).padStart(2, '0'),
        u = a < 12 ? 'am' : 'pm'
      return `${r}:${s} ${u}`
    }
    case 'hh:mm aa': {
...
const km = ['name', 'disabled', 'placeholder', 'value'],
  Sm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `time-input-${s}`),
        u = ref(null),
        g = ref(Fa(a.modelValue?.value, a.timeFormat))
      watch(
      ...
      function f(h2) {
        const D = h2.target.value,
          _ = Ye(D, 'HH:mm'),
          B = _ ? { formatted: Ye(D, a.timeFormat), value: _ } : void 0
      ...
      const m = computed(() => {
        ...
        x = computed(() => (a.block ? { width: '100%' } : { maxWidth: p[a.maxWidth] }))
      return (
        t({ focus: () => u.value?.focus() }),
        (h2, D) => (
          openBlock(),
...
function Am({ interval: e, max: t, min: n, timeFormat: a }) {
  const [o, s] = Pa(n),
    [r, u] = Pa(t),
    g = isNaN(Number(e)) ? 60 : Math.round(Ut(Number(e), 1, 180))
  let c, f, m, p
  o > r
    ? ((c = r), (f = u), (m = o), (p = s))
    : o === r && s > u
...
const Dm = {
  ...
  Cm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        ...
        u = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        g = computed(() => a.id ?? `agds-time-picker-${u}`),
        c = computed(() =>
          Am({
            interval: a.interval,
            max: a.max,
      ...
      const m = computed(() => wm(c.value, f.value)),
        p = ref(null)
      return (
        t({ focus: () => p.value?.querySelector('input')?.focus() }),
        (x, h2) => (
          openBlock(),
          createBlock(
            Pe,
            ...
            {
              default: withCtx(
                ({ id: D, 'aria-required': _, 'aria-invalid': B, 'aria-describedby': I }) => [
                  createVNode(
                    unref(ComboboxRoot),
                    {
                      modelValue: r.value,
                      ...
                      class: normalizeClass([
                        'agds-time-picker',
                        { 'agds-time-picker--block': e.block },
                      ]),
                    },
                    {
                      default: withCtx(() => [
                            ...
                            default: withCtx(() => [
                              createVNode(
                                unref(ComboboxInput),
                                {
                                  ...
                                  'display-value': (P) =>
                                    c.value.find((H) => H.value === P)?.label ?? '',
                                  ...
                                  createVNode(
                                    ...
                                    { class: 'agds-time-picker__listbox' },
                                    {
                                      default: withCtx(() => [
                                        e.loading
                                          ? (openBlock(),
                                            createElementBlock('div', Dm, ' Loading… '))
                                          : (openBlock(),
                                            createElementBlock(
                                              Fragment,
                                              { key: 1 },
  ...
  Im = /* @__PURE__ */ A(Cm, [['__scopeId', 'data-v-21fe7cc2']]),
  Mm = ['name', 'disabled', 'autofocus', 'inputmode', 'placeholder', 'rows', 'value'],
  Bm = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTextarea',
    props: {
      label: {},
      hideOptionalLabel: { type: Boolean, default: false },
  ...
  Lm = /* @__PURE__ */ A(Bm, [['__scopeId', 'data-v-634643e2']]),
  Tm = ['type', 'name', 'disabled', 'autocomplete', 'autofocus', 'maxlength', 'value'],
  Fm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `password-input-${s}`),
        u = ref(false),
        g = computed(() => (u.value ? 'text' : 'password')),
        c = ref(null)
      return (
        t({ focus: () => c.value?.focus() }),
        (f, m) => (
            ...
            { gap: 1 },
            {
              default: withCtx(() => [
                ...
                createVNode(
                  ...
                  {
                    default: withCtx(() => [
                      ...(m[5] || (m[5] = [createTextVNode(' Show password ', -1)])),
                    ]),
                    _: 1,
                  },
                  8,
  ...
  bb = /* @__PURE__ */ A(Fm, [['__scopeId', 'data-v-59a21484']]),
  Pm = ['name', 'disabled', 'autofocus', 'placeholder', 'value'],
  Om = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `search-input-${s}`),
        u = ref(null),
        g = ref(a.modelValue ?? ''),
        c = computed(() => (a.modelValue !== void 0 ? a.modelValue : g.value)),
        f = computed(() => !!c.value)
      ...
      const h2 = {
        ...
        D = computed(() => (a.block ? {} : { maxWidth: h2[a.maxWidth] }))
      return (
        t({ focus: () => u.value?.focus() }),
        (_, B) => (
          openBlock(),
  ...
  Vm = /* @__PURE__ */ A(Om, [['__scopeId', 'data-v-c7aabc07']]),
  Rm = ['name', 'disabled', 'autocomplete', 'autofocus', 'value'],
  Em = {
    key: 0,
    value: '',
  },
  ...
  Hm = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      const g = {
        ...
        c = computed(() => (a.block ? {} : { maxWidth: g[a.maxWidth] }))
      function f(m) {
                ...
                [
                  createElementVNode(
                    ...
                    [
                      a.placeholder
                        ? (openBlock(),
                          createElementBlock('option', Em, toDisplayString(a.placeholder), 1))
                        : createCommentVNode('', true),
                      (openBlock(true),
                      createElementBlock(
                        Fragment,
  ...
  Nm = /* @__PURE__ */ A(Hm, [['__scopeId', 'data-v-2d5949a5']]),
  jm = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      return (t, n) => (
        openBlock(),
        createBlock(
          resolveDynamicComponent(e.as),
          { class: 'agds-visually-hidden' },
          {
            default: withCtx(() => [renderSlot(t.$slots, 'default', {}, void 0, true)]),
            _: 3,
          },
        )
      )
  ...
  _t = /* @__PURE__ */ A(jm, [['__scopeId', 'data-v-b4329114']]),
  Wm = { class: 'agds-task-list-item__left' },
  Um = {
    class: 'agds-task-list-item__icon-desktop',
    'aria-hidden': 'true',
  },
  Zm = { class: 'agds-task-list-item__body' },
  Km = { class: 'agds-task-list-item__label' },
  Ym = {
    key: 0,
    class: 'agds-task-list-item__counter',
    'aria-hidden': 'true',
  },
  Xm = { class: 'agds-task-list-item__status' },
  Qm = { class: 'agds-task-list-item__status-label' },
  Jm = {
    key: 0,
      ...
      return (s, r) => (
        ...
        createElementBlock(
          ...
          [
            (openBlock(),
            createBlock(
              resolveDynamicComponent(n.value ? 'a' : 'button'),
              {
                  ...
                  createElementVNode('span', Wm, [
                    ...
                    createElementVNode('span', Zm, [
                      createElementVNode('span', Km, [
                        e.ordered
                          ? (openBlock(), createElementBlock('span', Ym))
                          : createCommentVNode('', true),
                        renderSlot(s.$slots, 'default', {}, void 0, true),
                        createVNode(_t, null, {
                          default: withCtx(() => [
                            ...(r[3] || (r[3] = [createTextVNode('.', -1)])),
                          ]),
                          _: 1,
                        }),
                      ]),
                      ...
                      e.message
                        ? (openBlock(),
                          createElementBlock('span', Jm, toDisplayString(e.message), 1))
                        : createCommentVNode('', true),
                    ]),
                  ]),
                  createVNode(_e, {
  ...
  tv = /* @__PURE__ */ A(ev, [['__scopeId', 'data-v-0aa12709']]),
  av = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTaskList',
    props: {
      items: {},
      ordered: { type: Boolean, default: false },
    ...
    setup(e) {
      const t = e,
        n = ['done', 'doneRecently'],
        a = computed(() => t.items.filter(({ status: o }) => n.includes(o)).length)
      return (o, s) => (
        openBlock(),
        createBlock(
          pt,
          ...
          },
          {
            default: withCtx(() => [
                ...
                { gap: 2 },
                {
                  default: withCtx(() => [
                    createVNode(
                      ...
                      {
                        default: withCtx(() => [
                          ...(s[0] || (s[0] = [createTextVNode('Complete these tasks', -1)])),
                        ]),
                        _: 1,
                      },
                    ),
                      ...
                      },
                      {
                        default: withCtx(() => [
                          createTextVNode(
                            toDisplayString(a.value) +
                              ' of ' +
                              toDisplayString(e.items.length) +
                              ' tasks completed ',
                            1,
                          ),
                        ]),
              ...
              (openBlock(),
              createBlock(
                resolveDynamicComponent(e.ordered ? 'ol' : 'ul'),
...
function nv(e, t) {
  ...
  for (const s of e)
    if (et(s)) o(s.href)
    else if (la(s)) for (const r of s.items) et(r) && o(r.href)
  return n
}
const ov = ['aria-label'],
  sv = {
  ...
  Oa = /* @__PURE__ */ A(rv, [['__scopeId', 'data-v-ba5cd09e']]),
  dv = ['id'],
  uv = { class: 'agds-main-nav-dialog__header' },
  cv = {
    'aria-label': 'Main',
  ...
  fv = { key: 0 },
  mv = ['href', 'aria-current'],
  vv = { key: 1 },
  pv = { class: 'agds-main-nav-dialog__group-label' },
  hv = {
    class: 'agds-main-nav-dialog__group-list',
    role: 'list',
  },
  bv = ['href', 'aria-current'],
  _v = ['onClick'],
  yv = { key: 2 },
  kv = ['onClick'],
  Sv = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      watch(
        ...
        async (g) => {
          g
            ? (await nextTick(), s.value?.focus(), ((void 0).body.style.overflow = 'hidden'))
      ...
      function u(g) {
        ...
        if (g.key === 'Tab') {
          const c = o.value?.querySelectorAll('a[href], button:not([disabled]), [tabindex="0"]')
          if (!c?.length) return
          const f = c[0],
            m = c[c.length - 1]
          g.shiftKey && (void 0).activeElement === f
            ? (g.preventDefault(), m.focus())
            : !g.shiftKey && (void 0).activeElement === m && (g.preventDefault(), f.focus())
        }
      }
      return (g, c) => (
        openBlock(),
                                ...
                                (f, m) => (
                                  ...
                                  createElementBlock(
                                    ...
                                    [
                                      unref(et)(f)
                                        ? (openBlock(),
                                          createElementBlock('li', fv, [
                                            createElementVNode(
                                              'a',
                                              {
                                                href: f.href,
                                                'aria-current':
                                                  f.href === n.activePath ? 'page' : void 0,
                                                class: normalizeClass([
  ...
  $v = /* @__PURE__ */ A(Sv, [['__scopeId', 'data-v-148afa34']]),
  xv = ['id'],
  wv = ['aria-hidden'],
  Av = ['aria-expanded'],
  Dv = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      const r = computed(() => nv([...(t.items ?? []), ...(t.secondaryItems ?? [])], t.activePath)),
        u = computed(() => (t.maxWidth === 'containerLg' ? '90rem' : '75rem')),
        g = computed(
          () =>
            ({
      ...
      return (c, f) => (
        ...
        createElementBlock(
          ...
          {
            id: t.id,
            class: normalizeClass(['agds-main-nav', `agds-main-nav--${t.background}`]),
            tabindex: '-1',
          },
          [
            t.focusMode
...
const Mv = ['href', 'aria-current', 'aria-label'],
  Bv = {
    key: 0,
  ...
  Tv = { class: 'agds-side-nav__link-label' },
  Fv = /* @__PURE__ */ defineComponent({
        ...
        return (
          ...
          createElementBlock(
            'ul',
            {
              class: normalizeClass([
                'agds-side-nav__list',
                { 'agds-side-nav__list--nested': e.depth > 1 },
              ]),
            },
            [
              (openBlock(true),
                      ...
                      [
                        createElementVNode(
                          'a',
                          {
                            ...
                            'aria-label': r(f)
                              ? `${f.label}${s(f) ? ', has expanded sub links' : ', has sub links'}`
                              : void 0,
                            class: normalizeClass([
                              'agds-side-nav__link',
                              {
                          ...
                          [
                            e.depth > 2
                              ? (openBlock(), createElementBlock('span', Bv, '—'))
                              : e.depth > 1
                                ? (openBlock(), createElementBlock('span', Lv, '–'))
                                : createCommentVNode('', true),
                                ...
                                createBlock(
                                  _e,
                                  {
                                    ...
                                    class: normalizeClass([
                                      ...
                                      { 'agds-side-nav__chevron--open': s(f) },
                                    ]),
                                  },
                                  null,
                                  8,
  ...
  Pv = /* @__PURE__ */ A(Fv, [['__scopeId', 'data-v-8082a636']]),
  Ov = ['aria-expanded'],
  Vv = { class: 'agds-side-nav__toggle-label' },
  Rv = { class: 'agds-side-nav__body' },
  Ev = { class: 'agds-side-nav__title-wrap' },
  Gv = /* @__PURE__ */ defineComponent({
    __name: 'AGDSSideNav',
    props: {
      activePath: {},
      background: { default: 'body' },
    ...
    setup(e) {
      const t = e,
        n = computed(() => Iv(t.items, t.activePath)),
        a = ref(false)
      function o() {
        a.value = !a.value
      }
          ...
          [
            ...
            createElementVNode('div', Rv, [
              createElementVNode('div', Ev, [
                (openBlock(),
                createBlock(
                  resolveDynamicComponent(t.titleLink ? 'a' : 'span'),
                  {
  ...
  qv = /* @__PURE__ */ A(Gv, [['__scopeId', 'data-v-11a923c4']]),
  zv = { class: 'agds-csb__title' },
  Hv = {
    key: 0,
    class: 'agds-csb__subtitle',
  },
  Nv = ['aria-expanded', 'aria-label'],
  jv = { class: 'agds-csb__toggle-content' },
  Wv = { class: 'agds-csb__toggle-text' },
  Uv = { class: 'agds-csb__toggle-title' },
  Zv = {
    key: 0,
                ...
                [
                  renderSlot(
                    ...
                    () => [
                      ...
                      t.subTitle
                        ? (openBlock(), createElementBlock('p', Hv, toDisplayString(t.subTitle), 1))
                        : createCommentVNode('', true),
                    ],
                    true,
                  ),
                ...
                [
                  createElementVNode('span', jv, [
                    createElementVNode('span', Wv, [
                      ...
                      t.subTitle
                        ? (openBlock(),
                          createElementBlock('span', Zv, toDisplayString(t.subTitle), 1))
                        : createCommentVNode('', true),
                    ]),
                    (openBlock(),
                    createElementBlock(
                      'svg',
                      {
                        class: normalizeClass([
                          'agds-csb__chevron',
                          { 'agds-csb__chevron--open': s.value },
                        ]),
                        'aria-hidden': 'true',
                        focusable: 'false',
                        xmlns: 'http://www.w3.org/2000/svg',
                      ...
                      [
                        ...(g[0] ||
                          (g[0] = [createElementVNode('path', { d: 'M6 9l6 6 6-6' }, null, -1)])),
                      ],
                      2,
                    )),
                  ]),
  ...
  Dn = /* @__PURE__ */ A(Kv, [['__scopeId', 'data-v-7efed014']]),
  Yv = { class: 'agds-filter-sidebar__body' },
  ...
  Qv = /* @__PURE__ */ A(Xv, [['__scopeId', 'data-v-e65e6b21']]),
  Jv = ['aria-label', 'id'],
  ep = { class: 'agds-sub-nav__list' },
  tp = ['href', 'aria-current'],
  ap = {
    key: 0,
  ...
  np = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      function n(o, s) {
        if (!s) return ''
        for (const u of o) if (u.href === s) return u.href
        let r = ''
        for (const u of o) s.startsWith(u.href) && u.href.length > r.length && (r = u.href)
        return r
      }
                  ...
                  (r) => (
                    ...
                    createElementBlock(
                      'li',
                      {
                        ...
                        class: normalizeClass([
                          'agds-sub-nav__item',
                          { 'agds-sub-nav__item--active': r.href === a.value },
                        ]),
                      },
                      [
                        createElementVNode(
                          'a',
                          {
                            ...
                            class: normalizeClass([
                              'agds-sub-nav__link',
                              { 'agds-sub-nav__link--active': r.href === a.value },
                            ]),
                          },
                          [
                            ...
                            r.endElement
                              ? (openBlock(),
                                createElementBlock('span', ap, toDisplayString(r.endElement), 1))
                              : createCommentVNode('', true),
                          ],
                          10,
                          tp,
  ...
  op = /* @__PURE__ */ A(np, [['__scopeId', 'data-v-ca9ecce9']]),
  sp = { class: 'agds-loading-blanket__content' },
  lp = ['role'],
  ip = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => (t.fullScreen ? 5 : 3)),
        a = computed(() => (t.fullScreen ? 'lg' : 'md'))
      return (o, s) => (
        openBlock(),
        createElementBlock(
          'div',
  ...
  rp = /* @__PURE__ */ A(ip, [['__scopeId', 'data-v-6155e75b']]),
  dp = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        n = computed(() => (t.max === void 0 || t.value <= t.max ? String(t.value) : `${t.max}+`))
      return (a, o) => (
        openBlock(),
        createElementBlock(
          'span',
          ...
          toDisplayString(n.value),
          3,
        )
      )
    },
  }),
  up = /* @__PURE__ */ A(dp, [['__scopeId', 'data-v-f340843e']]),
  Cn = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      return (t, n) => (
        ...
        createBlock(_t, null, {
          default: withCtx(() => [
            ...(n[0] || (n[0] = [createTextVNode(', opens in a new tab', -1)])),
          ]),
          _: 1,
        })
      )
  ...
  gp = /* @__PURE__ */ A(cp, [['__scopeId', 'data-v-b51ed348']]),
  fp = ['aria-label'],
  mp = {
    key: 0,
    class: 'agds-inpage-nav__title',
  },
  vp = { class: 'agds-inpage-nav__list' },
  pp = ['href'],
  hp = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      return (n, a) => (
        ...
        createElementBlock(
          ...
          [
            t.title
              ? (openBlock(), createElementBlock('h2', mp, toDisplayString(t.title), 1))
              : createCommentVNode('', true),
  ...
  bp = /* @__PURE__ */ A(hp, [['__scopeId', 'data-v-98e194d6']]),
  In = /* @__PURE__ */ Symbol('AgDSContentSpacing'),
  _p = /* @__PURE__ */ defineComponent({
  ...
  ia = /* @__PURE__ */ A(_p, [['__scopeId', 'data-v-3370447f']]),
    ...
    setup(e) {
      const t = e,
        ...
        a = computed(() => {
          ...
          return (
            s === false
              ? o.push('agds-content-bleed--no-bleed')
              : s != null &&
                typeof s == 'object' &&
                (s.xs === false && o.push('agds-content-bleed--no-bleed-xs'),
                s.md === false && o.push('agds-content-bleed--no-bleed-md')),
            o
          )
        })
      return (o, s) => (
  ...
  xp = /* @__PURE__ */ A($p, [['__scopeId', 'data-v-3c7e4fa4']]),
  wp = /* @__PURE__ */ defineComponent({
    __name: 'AGDSProse',
    props: {
      as: { default: 'div' },
    },
  ...
  Ip = /* @__PURE__ */ A(Cp, [['__scopeId', 'data-v-0698aeb1']]),
  Mp = ['aria-label'],
  Bp = /* @__PURE__ */ defineComponent({
  ...
  Lp = ['for'],
  Tp = { class: 'agds-search-box__input-wrapper' },
  Fp = ['id', 'name', 'placeholder', 'value'],
  Pp = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { expose: t, emit: n }) {
      const a = e,
        o = n,
        s = getCurrentInstance()?.uid ?? Math.random().toString(36).slice(2),
        r = computed(() => a.id ?? `search-${s}`),
        u = ref(null),
        g = ref(a.defaultValue ?? ''),
        c = computed(() => (a.modelValue !== void 0 ? a.modelValue : g.value)),
        f = computed(() => !!c.value)
      function m(x) {
        const h2 = x.target.value
                  ...
                  createElementVNode(
                    'input',
                    {
                      ...
                      class: normalizeClass([
                        ...
                        { 'agds-search-box__input--has-clear': f.value },
                      ]),
                      name: a.name,
                      placeholder: a.placeholder,
                      value: c.value,
  ...
  Op = /* @__PURE__ */ A(Pp, [['__scopeId', 'data-v-8d5aed32']]),
  Vp = { class: 'agds-search-box__button-wrapper' },
  Rp = {
    key: 0,
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 24 24',
  ...
  Gp = /* @__PURE__ */ A(Ep, [['__scopeId', 'data-v-9b3716b7']]),
  qp = { class: 'agds-progress-indicator__grid' },
  zp = {
    class: 'agds-progress-indicator__icon-col',
    'aria-hidden': 'true',
  },
  Hp = { class: 'agds-progress-indicator__status-text' },
  Np = { class: 'agds-progress-indicator__sub-list' },
  jp = { class: 'agds-progress-indicator__sub-item' },
  Wp = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = {
        ...
        n = e,
        a = computed(() => t[n.item.status]),
        o = computed(() => {
          const { iconColor: g } = a.value
          return n.item.isActive && g === 'border'
        ...
        s = computed(() => (n.item.href ? 'a' : 'button')),
        r = computed(() =>
        ...
        createElementBlock(
          ...
          [
            createElementVNode('span', qp, [
              ...
              (openBlock(),
              createBlock(
                resolveDynamicComponent(s.value),
                mergeProps(
                  {
                    class: [
                      'agds-progress-indicator__content',
                      { 'agds-progress-indicator__content--no-sub': !u.value },
                    ],
                  },
                    ...
                    [
                      ...
                      createElementVNode('ul', Np, [
                        createElementVNode('li', jp, [
                          (openBlock(),
                          createBlock(
                            resolveDynamicComponent(r.value.href ? 'a' : 'span'),
                            {
  ...
  Up = /* @__PURE__ */ A(Wp, [['__scopeId', 'data-v-cac787ce']]),
  Zp = ['aria-expanded'],
  Kp = { class: 'agds-progress-indicator__toggle-text' },
  Yp = {
    key: 0,
    class: 'agds-progress-indicator__subtitle',
  },
  Xp = { class: 'agds-progress-indicator__body' },
  Qp = { class: 'agds-progress-indicator__list' },
  Jp = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      const o = computed(() =>
          t.hideSubtitle
            ? void 0
            : `${t.items.filter((u) => u.status === 'done').length} of ${t.items.length} steps completed`,
        ),
        s = computed(() => {
          ...
          return t.items.map((u) => {
            ...
            if (r) g = !!u.isActive
              ...
              const f = u.href ?? u.label,
                m = f.endsWith('/') ? f : `${f}/`,
                p = !!t.activePath.split(m)[1]?.length
              g = t.activePath === f || p
            } else g = u.status === 'doing'
            ...
            createElementVNode(
              ...
              [
                createElementVNode('span', Kp, [
                  ...
                  o.value
                    ? (openBlock(), createElementBlock('span', Yp, toDisplayString(o.value), 1))
                    : createCommentVNode('', true),
                ]),
                (openBlock(),
                createElementBlock(
                  'svg',
                  {
                    class: normalizeClass([
                      ...
                      { 'agds-progress-indicator__chevron--open': n.value },
                    ]),
                    'aria-hidden': 'true',
                    xmlns: 'http://www.w3.org/2000/svg',
                    viewBox: '0 0 24 24',
  ...
  eh = /* @__PURE__ */ A(Jp, [['__scopeId', 'data-v-341abc83']]),
  Mn = /* @__PURE__ */ Symbol('AppLayout')
function Bn() {
  const e = inject(Mn)
  if (!e) throw new Error('useAppLayoutContext must be called within AgDSAppLayout')
  return e
}
const th = { class: 'agds-app-layout__body' },
  ah = { class: 'agds-app-layout__sidebar-col' },
  nh = { class: 'agds-app-layout__main' },
  oh = /* @__PURE__ */ defineComponent({
        ...
        (r, u) => (
          ...
          createElementBlock(
            'div',
            {
              class: normalizeClass([
                'agds-app-layout',
                { 'agds-app-layout--focus-mode': e.focusMode },
              ]),
            },
            [
              renderSlot(r.$slots, 'header', {}, void 0, true),
              createElementVNode('div', th, [
                createElementVNode('div', ah, [renderSlot(r.$slots, 'sidebar', {}, void 0, true)]),
                createElementVNode('div', nh, [renderSlot(r.$slots, 'default', {}, void 0, true)]),
              ]),
            ],
            2,
          )
  ...
  sh = /* @__PURE__ */ A(oh, [['__scopeId', 'data-v-dbac323b']]),
  lh = ['aria-expanded'],
  ih = { class: 'agds-app-layout-header__brand' },
  rh = {
    key: 1,
        ...
        createElementBlock(
          'header',
          {
            class: normalizeClass([
              ...
              [`agds-app-layout-header--${e.background}`],
            ]),
          },
          [
            createElementVNode(
                  ...
                  createVNode(
                    ...
                    createSlots({ _: 2 }, [
                      o.$slots.logo
                        ? {
                            name: 'logo',
                            fn: withCtx(() => [renderSlot(o.$slots, 'logo', {}, void 0, true)]),
                            key: '0',
                          }
                        : void 0,
                      o.$slots.secondLogo
...
function fh(e, t) {
  ...
  function o(s) {
    for (const r of s) lt(r) && (a(r.href), r.items && o(r.items))
  }
  for (const s of e) o(Ln(s))
  return n
}
function Tn(e, t) {
...
const mh = {
  ...
  vh = ['href', 'aria-current'],
  ph = {
    key: 1,
    'aria-hidden': 'true',
    class: 'agds-alsnav-item__dash',
  },
  hh = { class: 'agds-alsnav-item__label' },
  bh = {
    key: 0,
  ...
  yh = { class: 'agds-alsnav-item__label' },
  kh = {
    key: 2,
    class: 'agds-alsnav-item',
  },
  Sh = { class: 'agds-alsnav-item__text' },
  $h = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      const n = e,
        a = t,
        o = computed(() => lt(n.item)),
        s = computed(() => ch(n.item)),
        r = computed(() => (lt(n.item) ? n.item : null)),
        u = computed(() => lt(n.item) && n.item.href === n.activePath),
        g = computed(() =>
          lt(n.item) && n.item.items?.length ? Tn(n.item.items, n.activePath) : false,
        ),
        c = computed(() => n.subLevelVisible === 'always' || g.value || u.value),
        f = computed(() =>
      ...
      return (m, p) => {
        ...
        return o.value
          ? (openBlock(),
            createElementBlock('li', mh, [
              createElementVNode(
                ...
                [
                  r.value.icon && e.level === 1
                    ? (openBlock(),
                      createBlock(resolveDynamicComponent(r.value.icon), {
                        key: 0,
                        'aria-hidden': 'true',
                    ...
                    : createCommentVNode('', true),
                  e.level === 2
                    ? (openBlock(), createElementBlock('span', ph, '–'))
                    : createCommentVNode('', true),
                  createElementVNode('span', hh, toDisplayString(e.item.label), 1),
                  r.value.items?.length && e.subLevelVisible !== 'always'
                    ? (openBlock(),
                      createElementBlock(
                        'svg',
                        {
                          ...
                          class: normalizeClass([
                            ...
                            { 'agds-alsnav-item__chevron--open': g.value || u.value },
                          ]),
                        },
                        [
                          ...(p[3] ||
              ...
              r.value.items?.length && c.value
                ? (openBlock(),
                  createElementBlock('ul', bh, [
                    (openBlock(true),
                    createElementBlock(
                      Fragment,
                      null,
          ...
          : s.value
                ...
                createElementVNode(
                  ...
                  [
                    e.item.icon && e.level === 1
                      ? (openBlock(),
                        createBlock(resolveDynamicComponent(e.item.icon), {
                          key: 0,
                          'aria-hidden': 'true',
                          class: 'agds-alsnav-item__icon',
                        }))
            ...
            : (openBlock(),
              createElementBlock('li', kh, [
                createElementVNode('span', Sh, toDisplayString(e.item.label), 1),
              ]))
      }
    },
  }),
  xh = /* @__PURE__ */ A($h, [['__scopeId', 'data-v-67c9f167']]),
  wh = {
    'aria-label': 'Main',
    class: 'agds-alsnav',
  ...
  Dh = /* @__PURE__ */ defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      return (s, r) => (
        openBlock(),
        createElementBlock('nav', wh, [
          r[2] ||
            (r[2] = createElementVNode(
              'span',
              {
                              ...
                              class: normalizeClass([
                                'agds-alsnav__divider-item',
                                {
                                  'agds-alsnav__divider-item--no-top':
                                    o.value[g - 1].options?.disableGroupPadding,
                                  'agds-alsnav__divider-item--no-bottom':
                                    u.options?.disableGroupPadding,
                                },
                              ]),
                              'aria-hidden': 'true',
                            },
  ...
  Zt = /* @__PURE__ */ A(Dh, [['__scopeId', 'data-v-241d3927']]),
  Ch = { class: 'agds-alsdialog__header' },
  Ih = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      const t = e,
        { focusMode: n, isMobileMenuOpen: a, closeMobileMenu: o } = Bn(),
        s = computed(() => fh(t.items, t.activePath)),
        r = ref(null),
        u = ref(null)
      watch(a, async (c) => {
        c
          ? (await nextTick(), u.value?.focus(), ((void 0).body.style.overflow = 'hidden'))
          : ((void 0).body.style.overflow = '')
      })
      function g(c) {
        if (c.key === 'Escape') {
        ...
        if (c.key === 'Tab') {
          const f = r.value?.querySelectorAll('a[href], button:not([disabled]), [tabindex="0"]')
          if (!f?.length) return
          const m = f[0],
            p = f[f.length - 1]
          c.shiftKey && (void 0).activeElement === m
            ? (c.preventDefault(), p.focus())
            : !c.shiftKey && (void 0).activeElement === p && (c.preventDefault(), m.focus())
        }
      }
      return (c, f) => (
        openBlock(),
  ...
  Mh = /* @__PURE__ */ A(Ih, [['__scopeId', 'data-v-04bbdf06']]),
    ...
    setup(e) {
      return (t, n) => (
        ...
        createElementBlock(
          ...
          {
            class: normalizeClass([
              'agds-app-layout-footer',
              [`agds-app-layout-footer--${e.background}`],
            ]),
          },
          [
            createElementVNode(
  ...
  Lh = /* @__PURE__ */ A(Bh, [['__scopeId', 'data-v-5d10d449']]),
  Th = {
    'aria-hidden': 'true',
  ...
  Ph = /* @__PURE__ */ A(Fh, [['__scopeId', 'data-v-d84b2daf']]),
  Fn = /* @__PURE__ */ Symbol('AgDSTable'),
  Oh = ['tabindex', 'id'],
  ...
  Rh = /* @__PURE__ */ A(Vh, [['__scopeId', 'data-v-18818dfc']]),
  Eh = { class: 'agds-table-body' },
  Gh = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTableBody',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('tbody', Eh, [renderSlot(t.$slots, 'default')])
      )
    },
  }),
  qh = { class: 'agds-table-caption' },
  zh = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTableCaption',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('caption', qh, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  Hh = /* @__PURE__ */ A(zh, [['__scopeId', 'data-v-75160857']]),
  Nh = { class: 'agds-table-head' },
  jh = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTableHead',
    setup(e) {
      return (t, n) => (
        openBlock(),
        createElementBlock('thead', Nh, [renderSlot(t.$slots, 'default', {}, void 0, true)])
      )
    },
  }),
  Wh = /* @__PURE__ */ A(jh, [['__scopeId', 'data-v-fbb2216e']]),
  ...
  Zh = /* @__PURE__ */ A(Uh, [['__scopeId', 'data-v-168f5712']]),
  Kh = ['aria-sort', 'colSpan'],
        ...
        createElementBlock(
          'th',
          {
            class: normalizeClass([
              ...
              r.value && 'agds-table-header-sortable--active',
            ]),
            scope: 'col',
            'aria-sort': o.value,
            colSpan: n.colSpan,
            ...
            createElementVNode(
              'button',
              {
                ...
                class: normalizeClass([
                  ...
                  `agds-table-header-sortable__button--${n.textAlign}`,
                ]),
  ...
  Xh = /* @__PURE__ */ A(Yh, [['__scopeId', 'data-v-c8d8c343']]),
  Qh = /* @__PURE__ */ defineComponent({
  ...
  Jh = /* @__PURE__ */ A(Qh, [['__scopeId', 'data-v-6fa164c2']]),
  eb = ['aria-rowindex', 'aria-selected', 'data-has-background'],
  tb = /* @__PURE__ */ defineComponent({
    __name: 'AGDSTableRow',
    props: {
      'aria-rowindex': {},
      background: {},
    ...
    setup(e, { emit: t }) {
      const n = e,
        a = t,
        o = inject(Fn),
        s = computed(() => o?.tableLayout === 'fixed'),
        r = computed(() => !!(n.background || n.invalid))
      function u(g) {
        if (!n.clickable) return
        const c = g.target
        c.closest('a, button, input, label, select, textarea') ||
          (c.closest('tr') && (g.stopPropagation(), a('click', g)))
      }
      return (g, c) => (
        openBlock(),
        createElementBlock(
  ...
  ab = /* @__PURE__ */ A(tb, [['__scopeId', 'data-v-0f6abb19']]),
  nb = { class: 'agds-table-scroller' },
  ob = ['aria-label', 'tabindex'],
  sb = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      const h2 = computed(() => (m.value ? (a.value?.scrollLeft ?? 0) > 0 : false)),
        D = computed(() => {
      ...
      function B(O) {
        ;(O.preventDefault(),
          (u.value = true),
          O instanceof MouseEvent && O.button === 0
            ? ((o.x = O.pageX), (o.y = O.pageY))
            : O instanceof TouchEvent &&
              O.touches.length &&
              ((o.x = O.touches[0].pageX), (o.y = O.touches[0].pageY)))
      }
      function I(O) {
        ...
        else if (O instanceof MouseEvent) ((V = O.pageX), (N = O.pageY))
        else return
        const le = V - o.x,
          Q = N - o.y
        ;(Math.abs(le) > Math.abs(Q) &&
          (O.preventDefault(), (a.value.scrollLeft += le / c.value), (o.x = V)),
          (o.y = N))
      }
      function P() {
      ...
      watch(u, (O) => {
        O
          ? ((void 0).addEventListener('mousemove', I),
            (void 0).addEventListener('mouseup', P),
            (void 0).addEventListener('touchmove', I, { passive: false }),
            (void 0).addEventListener('touchend', P))
          : ((void 0).removeEventListener('mousemove', I),
            (void 0).removeEventListener('mouseup', P),
            (void 0).removeEventListener('touchmove', I),
            (void 0).removeEventListener('touchend', P))
      })
      function H(O) {
      ...
      function Y(O, V) {
        const N = V === 'left' ? -40 : 40,
          le = O instanceof TouchEvent || (O instanceof MouseEvent && O.button === 0)
              ...
              createElementVNode(
                'div',
                {
                  class: normalizeClass([
                    ...
                    h2.value && 'agds-table-scroller__shadow--visible',
                  ]),
              ...
              createElementVNode(
                'div',
                {
                  class: normalizeClass([
                    ...
                    D.value && 'agds-table-scroller__shadow--visible',
                  ]),
                  style: normalizeStyle({ height: `${s.value}px` }),
                  'aria-hidden': 'true',
                },
  ...
  lb = /* @__PURE__ */ A(sb, [['__scopeId', 'data-v-7aa60f5f']]),
  yb = {
    install(e) {
      ;(e.component('AgDSCore', ko),
        e.component('AgDSCoreProvider', Ga),
        e.component('AgDSBox', Ha),
        e.component('AgDSFlex', at),
        e.component('AgDSColumns', Io),
        e.component('AgDSColumn', Mo),
        e.component('AgDSFormStack', Na),
        e.component('AgDSStack', pt),
        e.component('AgDSBreadcrumbs', js),
        e.component('AgDSBreadcrumbsItem', vt),
        e.component('AgDSButton', Ue),
        e.component('AgDSButtonLink', nl),
        e.component('AgDSToggleButton', ol),
        e.component('AgDSAccordion', ll),
        e.component('AgDSAccordionItem', ul),
        e.component('AgDSAvatar', ml),
        e.component('AgDSCallout', _l),
        e.component('AgDSGlobalAlert', Cl),
        e.component('AgDSSectionAlert', zl),
        e.component('AgDSPageAlert', $i),
        e.component('AgDSCard', wi),
        e.component('AgDSCardHeader', Di),
        e.component('AgDSCardFooter', Ii),
        e.component('AgDSCardInner', Li),
        e.component('AgDSCardLink', Fi),
        e.component('AgDSDetails', Gi),
        e.component('AgDSTag', nn),
        e.component('AgDSTags', Wi),
        e.component('AgDSFooter', Zi),
        e.component('AgDSFooterDivider', Yi),
        e.component('AgDSHeader', fr),
        e.component('AgDSDivider', cn),
        e.component('AgDSHeading', He),
        e.component('AgDSH1', Yr),
        e.component('AgDSH2', Xr),
        e.component('AgDSH3', Qr),
        e.component('AgDSH4', Jr),
        e.component('AgDSH5', ed),
        e.component('AgDSH6', td),
        e.component('AgDSFeatureLinkList', ud),
        e.component('AgDSFeatureLinkListItem', gn),
        e.component('AgDSLinkList', pd),
        e.component('AgDSLinkListItem', fn),
        e.component('AgDSIcon', _e),
        e.component('AgDSUnorderedList', bd),
        e.component('AgDSOrderedList', yd),
        e.component('AgDSListItem', $d),
        e.component('AgDSText', mn),
        e.component('AgDSTable', Rh),
        e.component('AgDSTableBody', Gh),
        e.component('AgDSTableCaption', Hh),
        e.component('AgDSTableHead', Wh),
        e.component('AgDSTableHeader', Zh),
        e.component('AgDSTableHeaderSortable', Xh),
        e.component('AgDSTableCell', Jh),
        e.component('AgDSTableRow', ab),
        e.component('AgDSTableScroller', lb),
        e.component('AgDSAppLayout', sh),
        e.component('AgDSAppLayoutHeader', uh),
        e.component('AgDSAppLayoutSidebar', Mh),
        e.component('AgDSAppLayoutSidebarNav', Zt),
        e.component('AgDSAppLayoutFooter', Lh),
        e.component('AgDSAppLayoutFooterDivider', Ph),
        e.component('AgDSSideNav', qv),
        e.component('AgDSCollapsingSideBar', Dn),
        e.component('AgDSFilterSidebar', Qv),
        e.component('AgDSSubNav', op),
        e.component('AgDSMainNav', Cv),
        e.component('AgDSModal', ru),
        e.component('AgDSDrawer', fu),
        e.component('AgDSTabs', vu),
        e.component('AgDSTabList', hu),
        e.component('AgDSTab', yu),
        e.component('AgDSTabPanel', Su),
        e.component('AgDSPagination', qd),
        e.component('AgDSPaginationButtons', ou),
        e.component('AgDSCheckbox', bn),
        e.component('AgDSCheckboxGroup', Ou),
        e.component('AgDSSwitch', Qu),
        e.component('AgDSRadio', nc),
        e.component('AgDSRadioGroup', cc),
        e.component('AgDSCombobox', Fc),
        e.component('AgDSComboboxMulti', Gc),
        e.component('AgDSComboboxAsync', yn),
        e.component('AgDSComboboxAsyncMulti', ig),
        e.component('AgDSAutocomplete', rg),
        e.component('AgDSDatePicker', Jg),
        e.component('AgDSField', Pe),
        e.component('AgDSFieldContainer', Bt),
        e.component('AgDSFieldLabel', Lt),
        e.component('AgDSFieldHint', Tt),
        e.component('AgDSFieldMessage', Ft),
        e.component('AgDSFieldset', rf),
        e.component('AgDSGroupedFields', gf),
        e.component('AgDSCallToActionLink', vc),
        e.component('AgDSCallToActionButton', kc),
        e.component('AgDSDirectionLink', wc),
        e.component('AgDSDirectionButton', Bc),
        e.component('AgDSVisuallyHidden', _t),
        e.component('AgDSExternalLinkCallout', Cn),
        e.component('AgDSTextLink', Pt),
        e.component('AgDSTextLinkExternal', gp),
        e.component('AgDSInpageNav', bp),
        e.component('AgDSContent', yp),
        e.component('AgDSSectionContent', kp),
        e.component('AgDSPageContent', Sp),
        e.component('AgDSContentBleed', xp),
        e.component('AgDSProse', wp),
        e.component('AgDSSkipLinks', Ip),
        e.component('AgDSSummaryList', ei),
        e.component('AgDSSummaryListItem', ni),
        e.component('AgDSSummaryListItemTerm', li),
        e.component('AgDSSummaryListItemDescription', di),
        e.component('AgDSSummaryListItemAction', gi),
        e.component('AgDSProgressIndicator', eh),
        e.component('AgDSLoadingBlanket', rp),
        e.component('AgDSNotificationBadge', up),
        e.component('AgDSDropdownMenu', ln),
        e.component('AgDSDropdownMenuButton', rn),
        e.component('AgDSDropdownMenuPanel', dn),
        e.component('AgDSDropdownMenuItem', Dr),
        e.component('AgDSDropdownMenuItemLink', un),
        e.component('AgDSDropdownMenuItemRadio', Er),
        e.component('AgDSDropdownMenuGroup', qr),
        e.component('AgDSDropdownMenuDivider', Zr),
        e.component('AgDSSearchBox', Bp),
        e.component('AgDSSearchBoxInput', Op),
        e.component('AgDSSearchBoxButton', Gp),
        e.component('AgDSFileUpload', vm),
        e.component('AgDSTextInput', bm),
        e.component('AgDSTextarea', Lm),
        e.component('AgDSSearchInput', Vm),
        e.component('AgDSSelect', Nm),
        e.component('AgDSTimeInput', $m),
        e.component('AgDSTimePicker', Im))
    },
  }

export {
  ll as AgDSAccordion,
  ul as AgDSAccordionItem,
  sh as AgDSAppLayout,
  Lh as AgDSAppLayoutFooter,
  Ph as AgDSAppLayoutFooterDivider,
  uh as AgDSAppLayoutHeader,
  Mh as AgDSAppLayoutSidebar,
  Zt as AgDSAppLayoutSidebarNav,
  rg as AgDSAutocomplete,
  ml as AgDSAvatar,
  Ha as AgDSBox,
  js as AgDSBreadcrumbs,
  vt as AgDSBreadcrumbsItem,
  Ue as AgDSButton,
  nl as AgDSButtonLink,
  kc as AgDSCallToActionButton,
  vc as AgDSCallToActionLink,
  _l as AgDSCallout,
  wi as AgDSCard,
  Ii as AgDSCardFooter,
  Di as AgDSCardHeader,
  Li as AgDSCardInner,
  Fi as AgDSCardLink,
  bn as AgDSCheckbox,
  Ou as AgDSCheckboxGroup,
  Dn as AgDSCollapsingSideBar,
  Mo as AgDSColumn,
  Io as AgDSColumns,
  Fc as AgDSCombobox,
  yn as AgDSComboboxAsync,
  ig as AgDSComboboxAsyncMulti,
  Gc as AgDSComboboxMulti,
  yp as AgDSContent,
  xp as AgDSContentBleed,
  mb as AgDSControlGroup,
  ko as AgDSCore,
  Ga as AgDSCoreProvider,
  Jg as AgDSDatePicker,
  Gi as AgDSDetails,
  Bc as AgDSDirectionButton,
  wc as AgDSDirectionLink,
  cn as AgDSDivider,
  fu as AgDSDrawer,
  ln as AgDSDropdownMenu,
  rn as AgDSDropdownMenuButton,
  Zr as AgDSDropdownMenuDivider,
  qr as AgDSDropdownMenuGroup,
  Dr as AgDSDropdownMenuItem,
  un as AgDSDropdownMenuItemLink,
  Er as AgDSDropdownMenuItemRadio,
  dn as AgDSDropdownMenuPanel,
  Cn as AgDSExternalLinkCallout,
  ud as AgDSFeatureLinkList,
  gn as AgDSFeatureLinkListItem,
  Pe as AgDSField,
  Bt as AgDSFieldContainer,
  Tt as AgDSFieldHint,
  Lt as AgDSFieldLabel,
  Ft as AgDSFieldMessage,
  rf as AgDSFieldset,
  hb as AgDSFileInput,
  vm as AgDSFileUpload,
  Qv as AgDSFilterSidebar,
  at as AgDSFlex,
  Zi as AgDSFooter,
  Yi as AgDSFooterDivider,
  Na as AgDSFormStack,
  Cl as AgDSGlobalAlert,
  gf as AgDSGroupedFields,
  Yr as AgDSH1,
  Xr as AgDSH2,
  Qr as AgDSH3,
  Jr as AgDSH4,
  ...
  bp as AgDSInpageNav,
  pd as AgDSLinkList,
  fn as AgDSLinkListItem,
  $d as AgDSListItem,
  rp as AgDSLoadingBlanket,
  Cv as AgDSMainNav,
  ru as AgDSModal,
  up as AgDSNotificationBadge,
  yd as AgDSOrderedList,
  $i as AgDSPageAlert,
  Sp as AgDSPageContent,
  qd as AgDSPagination,
  ou as AgDSPaginationButtons,
  bb as AgDSPasswordInput,
  eh as AgDSProgressIndicator,
  wp as AgDSProse,
  nc as AgDSRadio,
  cc as AgDSRadioGroup,
  Bp as AgDSSearchBox,
  Gp as AgDSSearchBoxButton,
  Op as AgDSSearchBoxInput,
  Vm as AgDSSearchInput,
  zl as AgDSSectionAlert,
  kp as AgDSSectionContent,
  Nm as AgDSSelect,
  qv as AgDSSideNav,
  Ip as AgDSSkipLinks,
  pt as AgDSStack,
  fb as AgDSStatusBadge,
  op as AgDSSubNav,
  ei as AgDSSummaryList,
  ni as AgDSSummaryListItem,
  gi as AgDSSummaryListItemAction,
  di as AgDSSummaryListItemDescription,
  li as AgDSSummaryListItemTerm,
  Qu as AgDSSwitch,
  yu as AgDSTab,
  hu as AgDSTabList,
  Su as AgDSTabPanel,
  Rh as AgDSTable,
  Gh as AgDSTableBody,
  Hh as AgDSTableCaption,
  Jh as AgDSTableCell,
  Wh as AgDSTableHead,
  Zh as AgDSTableHeader,
  Xh as AgDSTableHeaderSortable,
  ab as AgDSTableRow,
  lb as AgDSTableScroller,
  vu as AgDSTabs,
  nn as AgDSTag,
  Wi as AgDSTags,
  _b as AgDSTaskList,
  tv as AgDSTaskListItem,
  mn as AgDSText,
  bm as AgDSTextInput,
  Pt as AgDSTextLink,
  gp as AgDSTextLinkExternal,
  Lm as AgDSTextarea,
  $m as AgDSTimeInput,
  Im as AgDSTimePicker,
  ol as AgDSToggleButton,
  bd as AgDSUnorderedList,
  _t as AgDSVisuallyHidden,
  yb as AgDSVue,
  hn as CHECKBOX_GROUP_KEY,
  Wu as CONTROL_GROUP_KEY,
  ao as CORE_CONTEXT_KEY,
  pb as GROUPED_FIELDS_DATA_ATTR,
  _n as RADIO_GROUP_KEY,
  _m as acceptedTimeFormats,
  so as boxPalette,
  oo as boxPalettes,
  Co as breakpointNames,
  yb as default,
  sa as filterOptions,
  pa as fontGrid,
  Je as formatFileSize,
  Ye as formatTime,
  Am as generateOptions,
  fa as goldTheme,
  cb as mapResponsiveProp,
  ct as mapSpacing,
  gb as mediaQueryMin,
  ma as mergeTheme,
  ub as packs,
  ...
  J as themeVars,
  qe as tokens,
  Fa as transformValuePropToInputValue,
  db as useBoxPalette,
  vn as usePagination,
  vb as useScrollToField,
}
