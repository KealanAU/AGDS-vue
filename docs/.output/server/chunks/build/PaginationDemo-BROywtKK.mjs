...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pagination-demo" }, _attrs))} data-v-403aacc2>`);
      if (unref(variant) === "link") {
        _push(ssrRenderComponent(_component_AgDSPagination, {
          "current-page": unref(currentPage),
          "total-pages": unref(totalPages),
          "generate-href": generateHref
        }, null, _parent));
      } else {
        _push(ssrRenderComponent(_component_AgDSPaginationButtons, {
          "current-page": unref(currentPage),
          "total-pages": unref(totalPages)
        }, null, _parent));
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/PaginationDemo.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const PaginationDemo = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-403aacc2"]]), { __name: "PaginationDemo" });
