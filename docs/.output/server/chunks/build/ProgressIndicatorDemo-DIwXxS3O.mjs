...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "max-width": "400px", "width": "100%" } }, _attrs))}>`);
      if (__props.variant === "statuses") {
        _push(ssrRenderComponent(unref(eh), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/ProgressIndicatorDemo.vue");
