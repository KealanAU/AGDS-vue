...
/** @type {__VLS_StyleScopedClasses['agds-side-nav__toggle']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__toggle-chevron']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav--expanded']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__body']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__toggle']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__body']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__title--link']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__title--link']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.nav, __VLS_intrinsics.nav)({
    ...{ class: "agds-side-nav" },
    ...{ class: ([
            `agds-side-nav--bg-${props.background}`,
            { 'agds-side-nav--expanded': __VLS_ctx.isExpanded },
        ]) },
});
/** @type {__VLS_StyleScopedClasses['agds-side-nav']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav--expanded']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
    ...{ class: "agds-side-nav__toggle-label" },
});
/** @type {__VLS_StyleScopedClasses['agds-side-nav__toggle-label']} */ ;
(props.title);
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "agds-side-nav__body" },
});
/** @type {__VLS_StyleScopedClasses['agds-side-nav__body']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "agds-side-nav__title-wrap" },
});
/** @type {__VLS_StyleScopedClasses['agds-side-nav__title-wrap']} */ ;
...
/** @type {__VLS_StyleScopedClasses['agds-side-nav__title']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-side-nav__title--link']} */ ;
