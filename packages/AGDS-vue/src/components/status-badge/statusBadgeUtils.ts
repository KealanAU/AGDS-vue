...
/**
 * 'filled'  → SVG fill="currentColor" + <path fill-rule="evenodd" clip-rule="evenodd">
 * 'outline' → SVG fill="none" stroke="currentColor" stroke-width="1.5" + <path>
 * 'dot'     → SVG fill="currentColor" + <circle cx="12" cy="12" r="4"> (neutral legacy)
 */
export type StatusBadgeIconVariant = 'filled' | 'outline' | 'dot'

export type StatusBadgeToneConfig = {
...
export const statusBadgeToneMap = {
  cannotStartLow: {
    iconVariant: 'outline', iconPath: ICON.noSymbol,
    iconLabel: 'cannot start',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  errorHigh: {
    iconVariant: 'filled', iconPath: ICON.alertFilled,
    iconLabel: 'error',
    borderColor: BORDER.error, iconColor: ICON_COLOR.error,
  },
  errorLow: {
    iconVariant: 'outline', iconPath: ICON.alertCircleOutline,
    iconLabel: 'error',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  errorMedium: {
    iconVariant: 'outline', iconPath: ICON.warningOutline,
    iconLabel: 'error',
    borderColor: BORDER.error, iconColor: ICON_COLOR.error,
  },
  infoHigh: {
    iconVariant: 'filled', iconPath: ICON.infoFilled,
    iconLabel: 'information',
    borderColor: BORDER.info, iconColor: ICON_COLOR.info,
  },
  infoLow: {
    iconVariant: 'outline', iconPath: ICON.infoOutline,
    iconLabel: 'information',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  infoMedium: {
  ...
  inProgressLow: {
    iconVariant: 'outline', iconPath: ICON.arrowPath,
    iconLabel: 'in progress',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  notStartedLow: {
    iconVariant: 'outline', iconPath: ICON.clock,
    iconLabel: 'not started',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  pausedLow: {
    iconVariant: 'outline', iconPath: ICON.pauseCircle,
    iconLabel: 'paused',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  successHigh: {
    iconVariant: 'filled', iconPath: ICON.successFilled,
    iconLabel: 'success',
    borderColor: BORDER.success, iconColor: ICON_COLOR.success,
  },
  successLow: {
    iconVariant: 'outline', iconPath: ICON.successOutline,
    iconLabel: 'success',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  successMedium: {
  ...
  unknownLow: {
    iconVariant: 'outline', iconPath: ICON.helpOutline,
    iconLabel: 'unknown',
    borderColor: BORDER.neutral, iconColor: ICON_COLOR.muted,
  },
  warningHigh: {
    iconVariant: 'filled', iconPath: ICON.warningFilled,
    iconLabel: 'warning',
    borderColor: BORDER.warning, iconColor: ICON_COLOR.warning,
  },
  warningLow: {
    iconVariant: 'outline', iconPath: ICON.alertCircleOutline,
    iconLabel: 'warning',
...
export const statusBadgeLegacyToneMap = {
  neutral: 'neutral',
