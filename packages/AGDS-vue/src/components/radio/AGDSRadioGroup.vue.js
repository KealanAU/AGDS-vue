...
/** @type {__VLS_StyleScopedClasses['agds-radio-group']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-radio-group--invalid']} */ ;
if (props.legend || __VLS_ctx.$slots.legend) {
    ...
    /** @type {__VLS_StyleScopedClasses['agds-radio-group__legend']} */ ;
    var __VLS_0 = {};
    (props.legend);
    if (props.required) {
        ...
        /** @type {__VLS_StyleScopedClasses['agds-radio-group__required']} */ ;
    }
}
if (__VLS_ctx.$slots.hint) {
    ...
    /** @type {__VLS_StyleScopedClasses['agds-radio-group__hint']} */ ;
    var __VLS_2 = {};
}
if (props.invalid && __VLS_ctx.$slots.message) {
    ...
    /** @type {__VLS_StyleScopedClasses['agds-radio-group__message']} */ ;
    var __VLS_4 = {};
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "agds-radio-group__items" },
});
/** @type {__VLS_StyleScopedClasses['agds-radio-group__items']} */ ;
var __VLS_6 = {};
// @ts-ignore
