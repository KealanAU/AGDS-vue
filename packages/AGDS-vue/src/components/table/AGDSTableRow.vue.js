...
/** @type {__VLS_StyleScopedClasses['agds-table-row--clickable']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--clickable']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--fixed']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--clickable']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--fixed']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--selected']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--fixed']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--selected']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--fixed']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-row--selected']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
    ...
    ...{ class: ([
            ...
            __VLS_ctx.isFixedTable && 'agds-table-row--fixed',
        ]) },
...
/** @type {__VLS_StyleScopedClasses['agds-table-row']} */ ;
var __VLS_0 = {};
// @ts-ignore
var __VLS_1 = __VLS_0;
// @ts-ignore
