...
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__button']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__button']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__button']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__icon']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__button']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__icon']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__label']} */ ;
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable__label']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)({
    ...{ class: "agds-table-header-sortable" },
    ...{ class: (__VLS_ctx.isSorted && 'agds-table-header-sortable--active') },
    scope: "col",
    'aria-sort': (__VLS_ctx.ariaSort),
    colSpan: (props.colSpan),
    ...{ style: (props.width ? { width: props.width } : undefined) },
});
/** @type {__VLS_StyleScopedClasses['agds-table-header-sortable']} */ ;
