export interface Theme {
  ...
  lightForegroundAction: string
  lightForegroundFocus: string
  lightForegroundMuted: string
  lightBackgroundBody: string
  lightBackgroundShade: string
  lightBackgroundBodyAlt: string
  lightBackgroundShadeAlt: string
  lightBorder: string
  lightBorderMuted: string
  lightSelected: string
  lightSelectedMuted: string
  lightAccent: string
  lightOverlay: string
  lightOverlayMuted: string
  lightSystemError: string
  lightSystemErrorMuted: string
  lightSystemSuccess: string
  lightSystemSuccessMuted: string
  lightSystemWarning: string
  lightSystemWarningMuted: string
  lightSystemInfo: string
  lightSystemInfoMuted: string
  darkForegroundText: string
  darkForegroundAction: string
  darkForegroundFocus: string
  darkForegroundMuted: string
  darkBackgroundBody: string
  darkBackgroundShade: string
  darkBackgroundBodyAlt: string
  darkBackgroundShadeAlt: string
  darkBorder: string
  darkBorderMuted: string
  darkSelected: string
  darkSelectedMuted: string
  darkAccent: string
  darkOverlay: string
  darkOverlayMuted: string
  darkSystemError: string
  darkSystemErrorMuted: string
  darkSystemSuccess: string
  darkSystemSuccessMuted: string
  darkSystemWarning: string
  darkSystemWarningMuted: string
  darkSystemInfo: string
  darkSystemInfoMuted: string
}

/** Maps each Theme key to its CSS custom property name on :root */
export const themeVars: Record<keyof Theme, string> = {
...
export function themeToVars(theme: Theme): Record<string, string> {
  return Object.fromEntries(
    (Object.keys(themeVars) as Array<keyof Theme>).map((key) => [
      themeVars[key],
      theme[key],
    ])
  )
